...
**Authority:** `Source/Stylesheet/Base.css`, `Source/Stylesheet/Global.css`,
...
Body content links are underlined unless they are a nav, logo, icon, social,
button, or aria-labeled card.
