  ...
  switch (Segment.Kind) {
    case "Code":
      return /* @__PURE__ */ jsxs("span", { className: "inline-flex items-baseline", children: [
        /* @__PURE__ */ jsx("code", { className: "rounded-none border border-[var(--Border)] bg-[var(--Mute)] px-1.5 py-0.5 font-mono text-[0.82em]", children: Segment.Value }),
...
const LineNode = ({
  ...
  if (EnableMatch) {
    ...
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs("span", { className: "inline-flex items-baseline", children: [
        /* @__PURE__ */ jsx("code", { className: "rounded-none border border-[var(--Border)] bg-[var(--Mute)] px-1.5 py-0.5 font-mono text-[0.82em]", children: Command }),
  ...
  if (DefaultFeaturesMatch) {
    ...
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      Items.map((Item, Index) => /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center", children: [
        ...
        ) : /* @__PURE__ */ jsx("code", { className: "rounded-none border border-[var(--Border)] bg-[var(--Mute)] px-1.5 py-0.5 font-mono text-[0.82em]", children: Item })
      ] }, Item)),
  ...
  if (IsCommandString(Trimmed)) {
    return /* @__PURE__ */ jsxs("span", { className: "inline-flex items-baseline", children: [
      /* @__PURE__ */ jsx("code", { className: "rounded-none border border-[var(--Border)] bg-[var(--Mute)] px-1.5 py-0.5 font-mono text-[0.82em]", children: Trimmed }),
    ...
    if (HasChildren) {
      return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(
        Collapsible,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs(CollapsibleTrigger, { className: "flex w-full items-center justify-between px-3 py-2 text-sm font-medium transition-colors hover:bg-[var(--ColorSecondary)] focus:outline-2 focus:outline-offset-2 focus:outline-[var(--ColorPrimary)]", children: [
                ...
                children: Section.Children.map((Child) => {
                  ...
                  return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(
                    "a",
                    {
                      ...
                      className: `block px-2 py-1 text-sm transition-colors hover:bg-[var(--ColorSecondary)] focus:outline-2 focus:outline-offset-2 focus:outline-[var(--ColorPrimary)] ${IsChildActive ? "bg-[var(--ColorSecondary)] font-medium" : "text-muted-foreground"}`,
