...
import 'piccolore';
import { r as renderComponent, a as renderTemplate, m as maybeRenderHead, F as Fragment$1, u as unescapeHTML } from './prerender_3pwDrPn4.mjs';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { useTranslation } from 'react-i18next';
import { H as Header } from './Header_xXukYMkP.mjs';
import * as lucide from 'lucide-react';
import { useRef, useEffect, useState } from 'react';
import { I as IconTooltip } from './IconTooltip_B9KPbq_s.mjs';
import { B as Badge, D as DynamicPlatformGrid } from './Badge_DNji9Drp.mjs';
  ...
  const ResolvedContent = content || {
    ...
    download: {
      ...
      onDownload: async (Platform) => {
        if (Platform.id) {
          try {
            const { default: DownloadAPI } = await import('./Download_BwXehaaN.mjs');
