...
import { n as BuildMailtoHref, r as GeneratePairId, t as BuildEmailBody } from "./Request_TjP0ZRRO.mjs";
import { useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { Copy, Mail, MessageSquare } from "lucide-react";
import { useAuth0 } from "@auth0/auth0-react";
//#region Source/Component/Dynamic/DynamicContactForm.tsx
var DynamicContactForm_default = ({ Config, Domain, ClientIdentifier }) => /* @__PURE__ */ jsx(Auth0Provider_default, {
	Children: /* @__PURE__ */ jsx(ContactFormInner, { Config }),
	...Domain ? { Domain } : {},
	...ClientIdentifier ? { ClientIdentifier } : {}
});
var ProviderLabel = (Sub) => {
...
var ContactFormInner = ({ Config }) => {
	const { user: User } = useAuth0();
	const Year = (/* @__PURE__ */ new Date()).getFullYear();
	const InitialValues = () => {
		const V = {};
		for (const Field of Config.Fields) if (Field.prefill === "name") V[Field.id] = User?.name || User?.nickname || "";
		else if (Field.prefill === "email") V[Field.id] = User?.email || "";
		else if (Field.prefill === "sub") V[Field.id] = User?.sub || "";
		else if (Field.prefill === "provider") V[Field.id] = ProviderLabel(User?.sub);
	...
	const Validate = () => {
		...
		for (const Field of Config.Fields) {
			...
			if (Field.type === "checkbox" && Value !== "true") NewErrors[Field.id] = "This confirmation is required.";
			else if (Field.type === "checkboxes" && Value.length === 0) NewErrors[Field.id] = "Select at least one option.";
			else if (Field.type !== "checkbox" && Field.type !== "checkboxes" && (!Value || Value.trim() === "")) NewErrors[Field.id] = "This field is required.";
		}
		SetErrors(NewErrors);
	...
	Config.Destructive || Config.Article;
	return /* @__PURE__ */ jsxs("div", {
		className: "mx-auto max-w-2xl space-y-8 px-4 py-12",
		children: [
			/* @__PURE__ */ jsxs("div", {
				className: "space-y-3",
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							Config.Article && /* @__PURE__ */ jsx("span", {
								className: "inline-flex items-center border border-[var(--Border)] bg-mute px-2 py-0.5 font-mono text-sm text-muted-foreground",
								children: Config.Article
							}),
							/* @__PURE__ */ jsxs("span", {
								className: "inline-flex items-center bg-mute px-2 py-0.5 font-mono text-sm text-muted-foreground",
								children: [Config.ResponseDays, "d SLA"]
							})
						]
					}),
					/* @__PURE__ */ jsx("h1", {
			...
			/* @__PURE__ */ jsx("div", {
				className: "StaccatoCard space-y-5 bg-card p-6",
				children: Config.Fields.map((Field) => {
					const Value = Values[Field.id];
					const Error = Errors[Field.id];
					if (Field.type === "checkbox") return /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("label", {
					...
					if (Field.type === "checkboxes") {
						...
						return /* @__PURE__ */ jsxs("div", { children: [
							...
							/* @__PURE__ */ jsx("div", {
								className: "space-y-2",
								children: (Field.options || []).map((Opt) => /* @__PURE__ */ jsxs("label", {
									className: "flex cursor-pointer items-center gap-2.5 text-sm",
									children: [/* @__PURE__ */ jsx("input", {
										type: "checkbox",
										className: "accent-[var(--Primary)]",
										checked: Selected.includes(Opt),
										onChange: () => HandleCheckboxGroup(Field.id, Opt)
									}), Opt]
								}, Opt))
							}),
							Error && /* @__PURE__ */ jsx("p", {
					...
					if (Field.type === "select") return /* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsxs("label", {
							htmlFor: Field.id,
						...
						/* @__PURE__ */ jsxs("select", {
							...
							children: [/* @__PURE__ */ jsx("option", {
								value: "",
								children: "Select..."
							}), (Field.options || []).map((Opt) => /* @__PURE__ */ jsx("option", {
								value: Opt,
								children: Opt
							}, Opt))]
						}),
					...
					if (Field.type === "textarea") return /* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsxs("label", {
							htmlFor: Field.id,
							className: "mb-1 block text-sm font-medium",
							children: [Field.label, Field.required && /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("p", {
						...
						children: "How would you like to send this?"
					}),
					/* @__PURE__ */ jsxs("a", {
						href: MailtoHref,
						onClick: Validate,
						...
						children: [/* @__PURE__ */ jsx(Mail, {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: "Open in email client"
							}), /* @__PURE__ */ jsx("div", {
								className: "text-sm text-muted-foreground",
								children: "Opens your default mail app with the form pre-filled as plain text - ready to review and send."
							})]
						})]
					}),
					/* @__PURE__ */ jsxs("button", {
						...
						children: [/* @__PURE__ */ jsx(Copy, {
							...
							children: [/* @__PURE__ */ jsx("div", {
								className: "font-medium",
								children: CopyState === "copied" ? "Copied to clipboard" : "Copy request text"
							}), /* @__PURE__ */ jsxs("div", {
								className: "text-sm text-muted-foreground",
								children: [
					...
					Config.ConversationHref && /* @__PURE__ */ jsxs("a", {
						...
						children: [/* @__PURE__ */ jsx(MessageSquare, {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								className: "text-sm text-muted-foreground",
								children: "Start a public or private thread - good for questions that benefit from community input."
							})]
						})]
					})
				]
			...
			/* @__PURE__ */ jsxs("div", {
				className: "border border-[var(--Border)] bg-mute px-5 py-4 text-sm text-muted-foreground",
				children: [
					/* @__PURE__ */ jsxs("span", {
...
//#endregion
export { DynamicContactForm_default as t };
