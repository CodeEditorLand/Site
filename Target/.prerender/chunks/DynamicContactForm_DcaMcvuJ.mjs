...
import { a as BuildMailtoHref, B as BuildEmailBody } from './Request_BPR7cplj.mjs';
...
${Body}`;
  ...
  const MailtoHref = Validate() ? BuildMailtoHref(Config, Values, Year) : `mailto:${Config.To}`;
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-2xl space-y-8 px-4 py-12", children: [
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex-1 text-left", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "text-xs text-muted-foreground", children: [
                "Copies a formatted plain-text version including the income code [",
                Config.Code,
                "-",
                Year,
    ...
    /* @__PURE__ */ jsxs("div", { className: "border border-[var(--Border)] bg-[var(--Mute)] px-5 py-4 text-xs text-muted-foreground", children: [
      ...
      " ",
      "is the reference identifier for this request type. Include it in any reply or follow-up so our team can route and track your request immediately. The full reference in your email will be",
      " ",
