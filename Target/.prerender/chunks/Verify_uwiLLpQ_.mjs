...
import { A as AuthAPI } from './Authentication_FUoNQ3KF.mjs';
import { Mail, CheckCircle, XCircle } from 'lucide-react';
import { useTranslation } from 'react-i18next';
import { C as Card, a as CardHeader, b as CardTitle, c as CardDescription, d as CardContent } from './Card_CQE5NtXL.mjs';
...
const DynamicEmailVerification = ({
  ...
  const RenderPending = () => /* @__PURE__ */ jsxs(Card, { className: "StaccatoCard StaccatoBorderShimmer StaccatoShadowLift", children: [
    /* @__PURE__ */ jsxs(CardHeader, { className: "text-center", children: [
      /* @__PURE__ */ jsx("div", { className: "bg-primary/10 mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-none", children: /* @__PURE__ */ jsx(Mail, { className: "h-6 w-6 text-primary", "aria-hidden": "true" }) }),
