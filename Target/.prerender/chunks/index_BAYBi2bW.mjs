...
import { MailCheck, EyeOff, Eye, ShieldCheck, Lock } from 'lucide-react';
import { useState } from 'react';
import { useTranslation } from 'react-i18next';
import { A as Auth0Provider } from './Auth0Provider_CCFoI4IT.mjs';
import { B as Button } from './Header_Bnn3YZ4O.mjs';
import { S as Skeleton } from './Skeleton_B9ps0c2Y.mjs';
import { D as DynamicAuthHeader } from './DynamicAuthHeader_DQ22gWl4.mjs';
...
const SourceBadge = ({
  label,
  icon
}) => /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 bg-[var(--Mute)] px-1.5 py-0.5 font-mono text-[10px] text-muted-foreground", children: [
  icon && /* @__PURE__ */ jsx(
    "img",
    {
      src: icon,
...
const FieldRow = ({
  ...
  /* @__PURE__ */ jsx("div", { className: "flex items-start justify-between gap-4", children: /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsx("span", { className: "text-sm font-medium", children: label }),
      /* @__PURE__ */ jsx(SourceBadge, { label: source, icon: sourceIcon }),
      editable ? /* @__PURE__ */ jsx("span", { className: "inline-flex items-center border border-blue-200 bg-blue-50 px-1.5 py-0 font-mono text-[10px] text-blue-600", children: "Editable" }) : /* @__PURE__ */ jsx("span", { className: "inline-flex items-center bg-[var(--Mute)] px-1.5 py-0 font-mono text-[10px] text-muted-foreground", children: "Read-only" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "mt-1 text-sm text-muted-foreground", children: value })
  ] }) }),
  editHint && /* @__PURE__ */ jsxs("p", { className: "mt-1.5 text-xs text-muted-foreground", children: [
    editHint,
    editHref && /* @__PURE__ */ jsxs(Fragment, { children: [
      " ",
      /* @__PURE__ */ jsx(
        "a",
        {
...
const Auth0Badge = () => /* @__PURE__ */ jsxs(
  "a",
  {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs("span", { children: [
        "Secured by",
        " ",
        /* @__PURE__ */ jsx("span", { className: "font-semibold", style: { color: "#EB5424" }, children: "Auth0" }),
        " ",
        "by Okta"
      ] })
    ]
...
const AccountProfileInner = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-2xl space-y-8 px-4 py-16", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-6", children: [
      /* @__PURE__ */ jsx(
        "div",
        {
          ...
          ) : /* @__PURE__ */ jsx("div", { className: "flex h-20 w-20 items-center justify-center bg-[var(--Mute)] text-2xl font-bold text-muted-foreground", children: DisplayName.slice(0, 2).toUpperCase() })
        }
      ),
      /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold", children: /* @__PURE__ */ jsx(Pii, { visible: PIIVisible, children: DisplayName }) }),
        /* @__PURE__ */ jsxs("div", { className: "mt-1 flex flex-wrap items-center gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-sm text-muted-foreground", children: /* @__PURE__ */ jsx(Pii, { visible: PIIVisible, children: User.email || "--" }) }),
          User.email_verified === true && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 border border-green-200 bg-green-50 px-1.5 py-0 text-[10px] font-medium text-green-700", children: [
            /* @__PURE__ */ jsx(
              MailCheck,
              {
                className: "h-2.5 w-2.5",
          ...
          User.email_verified === false && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center border border-yellow-200 bg-yellow-50 px-1.5 py-0 text-[10px] font-medium text-yellow-700", children: "Not Verified" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mt-2 flex flex-wrap gap-2", children: [
          ...
          ProviderIcon ? /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 bg-[var(--Mute)] px-2 py-0.5 text-xs font-medium text-muted-foreground", children: [
            /* @__PURE__ */ jsx(
              "img",
              {
                src: ProviderIcon,
          ...
          ] }) : /* @__PURE__ */ jsx("span", { className: "inline-flex items-center bg-[var(--Mute)] px-2 py-0.5 text-xs font-medium text-muted-foreground", children: /* @__PURE__ */ jsx(Pii, { visible: PIIVisible, children: ProviderLabel }) })
        ] })
      ] }),
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          children: PIIVisible ? /* @__PURE__ */ jsx(EyeOff, { className: "h-5 w-5", "aria-hidden": "true" }) : /* @__PURE__ */ jsx(Eye, { className: "h-5 w-5", "aria-hidden": "true" })
        }
      )
    ] }),
    IsEnterprise && /* @__PURE__ */ jsxs("div", { className: "border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-700", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxs("span", { children: [
          ...
          (OrganizationName || OrganizationIdentifier) && /* @__PURE__ */ jsxs(Fragment, { children: [
            " - ",
            /* @__PURE__ */ jsx(Pii, { visible: PIIVisible, children: /* @__PURE__ */ jsx("span", { className: "font-medium", children: OrganizationName || OrganizationIdentifier }) })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "mt-1 pl-6 text-xs text-green-600", children: "Profile fields are managed by your organization's identity provider. Contact your IT administrator to update them." })
    ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 border border-[var(--Border)] bg-[var(--Mute)] px-5 py-4", children: [
      /* @__PURE__ */ jsx(
        Lock,
        {
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-1", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-sm font-medium", children: "Your account data is stored securely" }),
          /* @__PURE__ */ jsx(Auth0Badge, {})
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Authentication, profile data, and session tokens are managed by Auth0 (by Okta) and stored on their EU infrastructure. Code Editor Land does not store your password. Social login credentials (Google, GitHub, etc.) remain with your identity provider." })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "StaccatoCard StaccatoBorderShimmer bg-white", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-[var(--Border)] px-6 py-4", children: [
        /* @__PURE__ */ jsx("h3", { className: "font-semibold", children: T("profileSection", {
          defaultValue: "Profile Fields"
        }) }),
        /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground", children: "All data stored in Auth0" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "divide-y divide-[var(--Border)]", children: [
        /* @__PURE__ */ jsx(
          ...
          {
            label: "Display Name",
            value: /* @__PURE__ */ jsx(Pii, { visible: PIIVisible, children: DisplayName }),
        ...
        /* @__PURE__ */ jsx(
          FieldRow,
          {
            ...
            value: /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx(Pii, { visible: PIIVisible, children: User.email || "--" }),
              User.email_verified === true && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 border border-green-200 bg-green-50 px-1.5 py-0 font-mono text-[10px] text-green-700", children: [
                /* @__PURE__ */ jsx(MailCheck, { className: "h-2.5 w-2.5" }),
                "verified"
              ] }),
              User.email_verified === false && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center border border-yellow-200 bg-yellow-50 px-1.5 py-0 font-mono text-[10px] text-yellow-700", children: "unverified" })
            ] }),
            source: IsSocialUser ? ProviderLabel : "Auth0",
            sourceIcon: IsSocialUser ? ProviderIcon : null,
        ...
        /* @__PURE__ */ jsx(
          FieldRow,
          {
            ...
            value: User.picture ? /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx(
                "span",
                {
              ...
              /* @__PURE__ */ jsx(Pii, { visible: PIIVisible, children: /* @__PURE__ */ jsxs("span", { className: "font-mono text-xs text-muted-foreground", children: [
        ...
        /* @__PURE__ */ jsx(
          ...
          {
            label: "User ID",
            value: /* @__PURE__ */ jsx("code", { className: "font-mono text-xs", children: /* @__PURE__ */ jsx(Pii, { visible: PIIVisible, children: User.sub || "--" }) }),
            source: "Auth0",
            editable: false,
        ...
        /* @__PURE__ */ jsx(
          ...
          {
            label: "Last Updated",
            value: /* @__PURE__ */ jsx(Pii, { visible: PIIVisible, children: MemberSince }),
            source: "Auth0",
            editable: false
          }
        ),
        IsEnterprise && (OrganizationName || OrganizationIdentifier) && /* @__PURE__ */ jsx(
          FieldRow,
          {
            label: "Organization",
            value: /* @__PURE__ */ jsx(Pii, { visible: PIIVisible, children: /* @__PURE__ */ jsx("span", { className: "font-medium", children: OrganizationName || OrganizationIdentifier }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "StaccatoCard StaccatoBorderShimmer bg-white", children: [
      /* @__PURE__ */ jsx("div", { className: "border-b border-[var(--Border)] px-6 py-4", children: /* @__PURE__ */ jsx("h3", { className: "font-semibold", children: "Security" }) }),
      /* @__PURE__ */ jsxs("div", { className: "divide-y divide-[var(--Border)]", children: [
        IsEmailPasswordUser && /* @__PURE__ */ jsx("div", { className: "px-6 py-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm font-medium", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "inline-flex items-center border border-blue-200 bg-blue-50 px-1.5 py-0 font-mono text-[10px] text-blue-600", children: "Editable" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: "A reset link is sent to your email. You will not be signed out until you set a new password." })
          ] }),
          PasswordResetState === "idle" && /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
          ...
          PasswordResetState === "sending" && /* @__PURE__ */ jsx("span", { className: "shrink-0 text-xs text-muted-foreground", children: "Sending…" }),
          PasswordResetState === "sent" && /* @__PURE__ */ jsxs("span", { className: "inline-flex shrink-0 items-center gap-1 border border-green-200 bg-green-50 px-2 py-1 text-xs text-green-700", children: [
            /* @__PURE__ */ jsx(MailCheck, { className: "h-3 w-3" }),
            "Email sent"
          ] }),
          PasswordResetState === "error" && /* @__PURE__ */ jsx("span", { className: "shrink-0 text-xs text-red-600", children: "Failed. Try again." })
        ] }) }),
        IsSocialUser && /* @__PURE__ */ jsxs("div", { className: "px-6 py-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm font-medium", children: [
            /* @__PURE__ */ jsx(
              Lock,
              {
            ...
            /* @__PURE__ */ jsx("span", { className: "inline-flex items-center bg-[var(--Mute)] px-1.5 py-0 font-mono text-[10px] text-muted-foreground", children: "Not applicable" })
          ] }),
          /* @__PURE__ */ jsxs("p", { className: "mt-1 text-xs text-muted-foreground", children: [
            ...
            ProviderProfileUrl && /* @__PURE__ */ jsxs(Fragment, { children: [
              " ",
              /* @__PURE__ */ jsxs(
                "a",
                {
        ...
        /* @__PURE__ */ jsxs("div", { className: "px-6 py-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm font-medium", children: [
            ...
            "Active Session",
            /* @__PURE__ */ jsx(SourceBadge, { label: "Auth0" }),
            /* @__PURE__ */ jsx("span", { className: "inline-flex items-center bg-[var(--Mute)] px-1.5 py-0 font-mono text-[10px] text-muted-foreground", children: "Read-only" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: "Session managed by Auth0. Signing out revokes the session token on Auth0's servers and clears local storage. Access token validity: 1 hour." })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "StaccatoCard StaccatoBorderShimmer bg-white", children: [
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "Title": MetaTitle, "Description": MetaDescription, "Url": "https://land.playform.cloud/Account", "lang": "en" }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "DynamicAuthHeader", DynamicAuthHeader, { "client:load": true, "Domain": Auth0Domain, "ClientIdentifier": Auth0ClientIdentifier, "client:component-hydration": "load", "client:component-path": "/Volumes/CORSAIR/Developer/macOS/Application/CodeEditorLand/WebSite/Source/Component/Dynamic/DynamicAuthHeader", "client:component-export": "default" })} ${maybeRenderHead()}<main id="main-content"> <div class="container mx-auto max-w-5xl px-4"> <!-- Breadcrumbs --> <nav aria-label="Breadcrumb" class="pt-6"> <ol class="flex flex-wrap items-center space-x-2 text-muted-foreground"> <li> <a href="/" class="transition-colors hover:text-foreground">${T("common.breadcrumb.home", {
    defaultValue: "Home"
