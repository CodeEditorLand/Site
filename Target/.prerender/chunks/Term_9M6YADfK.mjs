...
<a href="/">https://land.playform.cloud</a>, our desktop application, APIs, Cloudflare Workers,
...
<a href="/Legal/Privacy">https://land.playform.cloud/Legal/Privacy</a>.
</p> <p>
...
If you do not agree with (or cannot comply with) Agreements,
				...
				or emailing <a href="mailto:legal@land.playform.cloud">legal@land.playform.cloud</a>
...
By creating an account on our Service, you agree to subscribe to
				...
				or by using the <a href="/Contact/Leave">Withdraw Consent form</a> (LEAVE) or emailing <a href="mailto:support@land.playform.cloud">support@land.playform.cloud</a>.
...
If you are a copyright owner, or authorized on behalf of one,
				...
				claim using the <a href="”/Contact/Claim”">Copyright &amp; DMCA form</a> (CLAIM) or by emailing <a href="”mailto:copyright@land.playform.cloud”">copyright@land.playform.cloud</a> or <a href="”mailto:legal@land.playform.cloud”">legal@land.playform.cloud</a> and include in your claim a detailed description of the alleged
...
You can contact our Copyright Agent using the <a href="/Contact/Claim">Copyright & DMCA form</a> (CLAIM) or by email at <a href="mailto:copyright@land.playform.cloud">copyright@land.playform.cloud</a>.
...
If you wish to terminate your account, you may simply
				discontinue using Service or request deletion through the <a href="/Contact/Erase">Account Deletion form</a> (ERASE) or by contacting <a href="mailto:support@land.playform.cloud">support@land.playform.cloud</a>.
</p> <p>
...
By email: <a href="mailto:support@land.playform.cloud">support@land.playform.cloud</a>, <a href="mailto:legal@land.playform.cloud">legal@land.playform.cloud</a>, <a href="mailto:copyright@land.playform.cloud">copyright@land.playform.cloud</a>.
</p> <p>
By GitHub Issues:
<a href="https://github.com/CodeEditorLand/Land/issues" target="_blank" rel="noopener noreferrer">https://github.com/CodeEditorLand/Land/issues</a>.
	...
	<\/script> `], [" ", " ", '<div class="container mx-auto max-w-4xl px-4 py-16"> <nav aria-label="Breadcrumb" class="LegalPrintHide mb-8"> <ol class="flex flex-wrap items-center space-x-2 text-muted-foreground"> <li> <a href="/" class="transition-colors hover:text-foreground">Home</a> </li> <li class="mx-2">/</li> <li> <span class="font-medium text-foreground">Terms of Service</span> </li> </ol> </nav> <header class="mb-12"> <h1 class="text-2xl font-semibold tracking-tight sm:text-3xl">\nTerms of Service\n</h1> <div class="space-y-1 text-muted-foreground"> <p><strong>Effective Date:</strong> ', "</p> <p><strong>Last Updated:</strong> ", '</p> </div> </header> <article class="LegalCard prose prose-slate max-w-none"> <ul class="LegalPrintHide"> <li> <a href="#terms-of-service">TERMS OF SERVICE</a> <ul> <li><a href="#introduction">Introduction</a></li> <li><a href="#communications">Communications</a></li> <li><a href="#purchases">Purchases</a></li> <li> <a href="#contests-sweepstakes-and-promotions">Contests, Sweepstakes and Promotions</a> </li> <li><a href="#subscriptions">Subscriptions</a></li> <li><a href="#free-trial">Free Trial</a></li> <li><a href="#fee-changes">Fee Changes</a></li> <li><a href="#refunds">Refunds</a></li> <li><a href="#content">Content</a></li> <li><a href="#prohibited-uses">Prohibited Uses</a></li> <li> <a href="#no-use-by-minors">No Use by Minors</a> </li> <li><a href="#accounts">Accounts</a></li> <li> <a href="#intellectual-property">Intellectual Property</a> </li> <li> <a href="#copyright-policy">Copyright Policy</a> </li> <li> <a href="#dmca-notice-and-procedure-for-copyright-infringement-claims">DMCA Notice and Procedure for Copyright\n								Infringement Claims</a> </li> <li> <a href="#error-reporting-and-feedback">Error Reporting and Feedback</a> </li> <li> <a href="#links-to-other-web-sites">Links To Other Web Sites</a> </li> <li> <a href="#disclaimer-of-warranty">Disclaimer Of Warranty</a> </li> <li> <a href="#limitation-of-liability">Limitation Of Liability</a> </li> <li><a href="#termination">Termination</a></li> <li><a href="#governing-law">Governing Law</a></li> <li> <a href="#changes-to-service">Changes To Service</a> </li> <li> <a href="#amendments-to-terms">Amendments To Terms</a> </li> <li> <a href="#waiver-and-severability">Waiver And Severability</a> </li> <li> <a href="#acknowledgement">Acknowledgement</a> </li> <li><a href="#contact-us">Contact Us</a></li> </ul> </li> </ul> <h1 id="terms-of-service">TERMS OF SERVICE</h1> <p> <strong>Effective date:</strong> ', "<br> <strong>Last updated:</strong> ", ` </p> <h2 id="introduction">Introduction</h2> <p>
Welcome to Code Editor Land (“<strong>Company</strong>”, “<strong>we</strong>”, “<strong>our</strong>”, “<strong>us</strong>”)! As you have
				just clicked our Terms of Service, please pause, grab a cup of
				coffee and carefully read the following pages.
</p> <p>
