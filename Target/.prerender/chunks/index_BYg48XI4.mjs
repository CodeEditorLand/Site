...
import 'piccolore';
import { r as renderComponent, a as renderTemplate, m as maybeRenderHead, F as Fragment$1, u as unescapeHTML } from './prerender_DmvbPVCR.mjs';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { useTranslation } from 'react-i18next';
import { H as Header } from './Header_DT5JaKy6.mjs';
import * as lucide from 'lucide-react';
import { useRef, useEffect, useState } from 'react';
import { I as IconTooltip } from './IconTooltip_DfuHnqUe.mjs';
import { B as Badge, D as DynamicPlatformGrid } from './Badge_CVwJlP7-.mjs';
import { D as DynamicButton } from './DynamicButton_HuyDbSiu.mjs';
  ...
  const ResolvedContent = content || {
    ...
    download: {
      ...
      onDownload: async (Platform) => {
        if (Platform.id) {
          try {
            const { default: DownloadAPI } = await import('./Download_BROsqTYL.mjs');
