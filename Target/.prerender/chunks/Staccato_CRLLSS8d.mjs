const Staccato = (async () => {
  ...
  const Config = (await import('./Noise_BQs1Y4XW.mjs')).default;
  const Turbulence = (await import('./Turbulence_MCudHMuZ.mjs').then(n => n.T)).default;
  const ParallaxModule = (await import('./Parallax_BTqxBt7K.mjs')).default;
