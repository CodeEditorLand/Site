...
import { A as AuthAPI } from './Authentication_CP1V5IvY.mjs';
import { H as Header } from './Header_CrTCyJxT.mjs';
import { C as Card, d as CardHeader, e as CardTitle, b as CardDescription, a as CardContent, c as CardFooter } from './Card_BbdT77gO.mjs';
import { D as DynamicButton } from './DynamicButton_fYh4o-a_.mjs';
import { D as DynamicInput, L as Label } from './DynamicInput_CJWY4u31.mjs';
import * as lucide from 'lucide-react';
import { useTranslation } from 'react-i18next';
import * as CheckboxPrimitive from '@radix-ui/react-checkbox';
import { c as cn } from './Base_C_b_uBI-.mjs';
      ...
      "div",
      {
        ...
        children: [
          ...
          ResendButton && /* @__PURE__ */ jsxs("div", { className: "border-t border-border pt-4", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "mt-2 text-muted-foreground", children: "Didn't receive the email?" })
          ] }),
    ...
    return /* @__PURE__ */ jsx("section", { className: "py-20", "aria-label": "Reset password", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx(Card, { className: "StaccatoCard StaccatoBorderShimmer StaccatoShadowLift", children: /* @__PURE__ */ jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxs("div", { className: "space-y-4", role: "alert", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: InvalidTokenMessage || "This password reset link is invalid or has expired. Please request a new one." })
        ] }) }) })
      }
    ) }) });
  }
        ...
        children: /* @__PURE__ */ jsx(Card, { className: "StaccatoCard StaccatoBorderShimmer StaccatoShadowLift", children: /* @__PURE__ */ jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: SuccessMessage || "Your password has been reset successfully. You can now sign in with your new password." })
            ]
          }
        ) }) })
      }
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            Password && /* @__PURE__ */ jsx(
              "div",
              {
                ...
                children: [0, 1, 2].map((Segment) => /* @__PURE__ */ jsx(
                  "div",
                  {
                    className: "h-1 flex-1 rounded-none transition-colors",
                    style: {
                      backgroundColor: Password.length >= 12 && /[^a-zA-Z0-9]/.test(
                        Password
                      ) ? "var(--ColorSuccess, #16a34a)" : Password.length >= 8 && Segment < 2 ? "var(--ColorWarning, #ca8a04)" : Password.length >= 6 && Segment < 1 ? "var(--ColorDestruct, #dc2626)" : "var(--Border, #e5e7eb)"
                    }
                  },
                  Segment
                ))
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-20", "aria-label": "Sign in", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsx("div", { className: `mx-auto max-w-md ${ClassName}`, children: /* @__PURE__ */ jsxs(Card, { className: "StaccatoCard StaccatoBorderShimmer StaccatoShadowLift", children: [
    ...
    /* @__PURE__ */ jsxs(CardContent, { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              ...
              /* @__PURE__ */ jsx(
                "button",
                {
                  type: "button",
                  className: "absolute right-3 top-2 text-muted-foreground hover:text-foreground",
                  "aria-label": ShowPassword ? T("signIn.hidePassword", {
      ...
      ShowDivider && /* @__PURE__ */ jsxs("div", { className: "relative my-6", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "relative flex justify-center uppercase", children: /* @__PURE__ */ jsx("span", { className: "bg-background px-2 text-muted-foreground", children: "Or" }) })
      ] }),
    ...
    /* @__PURE__ */ jsxs(CardFooter, { className: "flex flex-col gap-3 text-center", children: [
      FooterLinks?.SignUp && /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-1 text-muted-foreground", children: "Don't have an account?" })
      ] }),
      FooterLinks?.ForgotPassword && /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-1 text-muted-foreground", children: "Forgot your password?" })
      ] })
    ] })
  ] }) }) }) });
};
...
const DynamicCheckbox = ({ Content, Name, OnCheckedChange }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-start space-x-3", children: [
    ...
    (LabelText || Description) && /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
...
const DynamicSignUp = ({
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-20", "aria-label": "Sign up", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsx("div", { className: `mx-auto max-w-md ${ClassName}`, children: /* @__PURE__ */ jsxs(Card, { className: "StaccatoCard StaccatoBorderShimmer StaccatoShadowLift", children: [
    ...
    /* @__PURE__ */ jsxs(CardContent, { children: [
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                ...
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    type: "button",
                    className: "absolute right-3 top-2 text-muted-foreground hover:text-foreground",
                    "aria-label": ShowPassword ? T("signUp.hidePassword", {
                      defaultValue: "Hide password"
              ...
              Password && /* @__PURE__ */ jsx(
                ...
                {
                  className: "mt-1 flex gap-1",
                  "aria-label": Password.length >= 12 && /[^a-zA-Z0-9]/.test(Password) ? T(
      ...
      OauthButtons.length > 0 && /* @__PURE__ */ jsx("div", { className: "space-y-3", children: OauthButtons.map((ButtonItem, Index) => /* @__PURE__ */ jsx(
        DynamicButton,
        {
          Content: {
            ...ButtonItem,
    ...
    /* @__PURE__ */ jsx(CardFooter, { className: "flex flex-col gap-3 text-center", children: FooterLinks?.SignIn && /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsx("p", { className: "mt-1 text-muted-foreground", children: "Already have an account?" })
    ] }) })
  ] }) }) }) });
};
