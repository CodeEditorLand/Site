  ...
  useEffect(() => {
    ...
    const FetchPlatforms = async () => {
      try {
        ...
        const { GetWorkersClient } = await import('./Base_C_b_uBI-.mjs').then(n => n.W);
          ...
          "div",
          {
            ...
            children: Platforms.map((Platform) => {
              ...
              const PlatformCardSection = {
                ...
                Body: {
                  content: /* @__PURE__ */ jsxs("div", { className: "space-y-2 text-muted-foreground", children: [
                ...
                ...HasVerification ? {
                  Footer: {
                    content: /* @__PURE__ */ jsxs("div", { className: "text-muted-foreground", children: [
