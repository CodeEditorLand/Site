...
//#region Source/pages/Legal/Term.astro
var Term_exports = /* @__PURE__ */ __exportAll({
	default: () => $$Term,
	file: () => $$file,
	url: () => $$url
});
...
var $$Term = createComponent(($$result, $$props, $$slots) => {
	...
	Astro.self = $$Term;
	const T = GetI18n();
	const MetaTitle = T("meta.legal.terms.title", { defaultValue: "Terms of Service | Code Editor Land" });
	const MetaDescription = T("meta.legal.terms.description", { defaultValue: "Terms of Service for Code Editor Land - Governing your use of our open-source code editor and related services." });
...
Terms of Service
</h1> <div class="space-y-1 text-muted-foreground"> <p><strong>Effective Date:</strong> ${EffectiveDate}</p> <p><strong>Last Updated:</strong> ${LastUpdated}</p> </div> </header> <article class="LegalCard prose prose-slate dark:prose-invert max-w-none"> <ul class="LegalPrintHide"> <li> <a href="#terms-of-service">TERMS OF SERVICE</a> <ul> <li><a href="#introduction">Introduction</a></li> <li><a href="#communications">Communications</a></li> <li><a href="#purchases">Purchases</a></li> <li> <a href="#contests-sweepstakes-and-promotions">Contests, Sweepstakes and Promotions</a> </li> <li><a href="#subscriptions">Subscriptions</a></li> <li><a href="#free-trial">Free Trial</a></li> <li><a href="#fee-changes">Fee Changes</a></li> <li><a href="#refunds">Refunds</a></li> <li><a href="#content">Content</a></li> <li><a href="#prohibited-uses">Prohibited Uses</a></li> <li> <a href="#no-use-by-minors">No Use by Minors</a> </li> <li><a href="#accounts">Accounts</a></li> <li> <a href="#intellectual-property">Intellectual Property</a> </li> <li> <a href="#copyright-policy">Copyright Policy</a> </li> <li> <a href="#dmca-notice-and-procedure-for-copyright-infringement-claims">DMCA Notice and Procedure for Copyright
								Infringement Claims</a> </li> <li> <a href="#error-reporting-and-feedback">Error Reporting and Feedback</a> </li> <li> <a href="#links-to-other-web-sites">Links To Other Web Sites</a> </li> <li> <a href="#disclaimer-of-warranty">Disclaimer Of Warranty</a> </li> <li> <a href="#limitation-of-liability">Limitation Of Liability</a> </li> <li><a href="#termination">Termination</a></li> <li><a href="#governing-law">Governing Law</a></li> <li> <a href="#changes-to-service">Changes To Service</a> </li> <li> <a href="#amendments-to-terms">Amendments To Terms</a> </li> <li> <a href="#waiver-and-severability">Waiver And Severability</a> </li> <li> <a href="#acknowledgement">Acknowledgement</a> </li> <li><a href="#contact-us">Contact Us</a></li> </ul> </li> </ul> <h1 id="terms-of-service">TERMS OF SERVICE</h1> <p> <strong>Effective date:</strong> ${EffectiveDate}<br> <strong>Last updated:</strong> ${LastUpdated} </p> <h2 id="introduction">Introduction</h2> <p>
Welcome to Code Editor Land (“<strong>Company</strong>”, “<strong>we</strong>”, “<strong>our</strong>”, “<strong>us</strong>”)! As you have
				just clicked our Terms of Service, please pause, grab a cup of
				coffee and carefully read the following pages.
</p> <p>
These Terms of Service (“<strong>Terms</strong>”, “<strong>Terms of Service</strong>”) govern your use of our web pages located at
<a href="/">https://editor.land</a>, our desktop application, APIs, Cloudflare Workers,
				documentation, downloads, account services, synchronization
				features, and any related services (together or individually “<strong>Service</strong>”) operated by PlayForm, based in Sofia, Bulgaria, as steward
				of the Code Editor Land open-source project.
</p> <p>
Our Privacy Policy also governs your use of our Service and
				explains how we collect, safeguard and disclose information that
				results from your use of our web pages. Please read it here:
<a href="/Legal/Privacy">https://editor.land/Legal/Privacy</a>.
</p> <p>
...
If you do not agree with (or cannot comply with) Agreements,
				...
				using the <a href="/Contact/Legal">Legal Enquiry form</a> (LEGAL)
				or emailing <a href="mailto:legal@editor.land">legal@editor.land</a>
so we can try to find a solution. These Terms apply to all visitors,
				users and others who wish to access or use Service.
</p> <p>Thank you for being responsible.</p> <h2 id="communications">Communications</h2> <p>
By creating an account on our Service, you agree to subscribe to
				newsletters, service announcements, security notifications,
				...
				or by using the <a href="/Contact/Leave">Withdraw Consent form</a> (LEAVE) or emailing <a href="mailto:support@editor.land">support@editor.land</a>.
</p> <h2 id="purchases">Purchases</h2> <p>
...
</p> <p>You represent and warrant that:</p> <ol class="LegalList"> <li>
you have the legal right to use any credit card(s) or other
					payment method(s) in connection with any Purchase; and
</li> <li>
...
</p> <h2 id="contests-sweepstakes-and-promotions">
Contests, Sweepstakes and Promotions
</h2> <p>
Any contests, sweepstakes or other promotions (collectively, “<strong>Promotions</strong>”) made available through Service may be governed by rules that
...
</p> <h2 id="subscriptions">Subscriptions</h2> <p>
Some parts of Service are billed on a subscription basis (“<strong>Subscription</strong>(<strong>s</strong>)”). You will be billed in advance on a
				recurring and periodic basis (“<strong>Billing Cycle</strong>”).
...
A valid payment method, including credit card or PayPal, is
				...
				payment information, you automatically authorize us to charge
				all Subscription fees incurred through your account to any such
				payment instruments.
</p> <p>
Should automatic billing fail to occur for any reason, we will
...
</p> <h2 id="free-trial">Free Trial</h2> <p>
We may, at our sole discretion, offer a Subscription with a free
				trial for a limited period of time (“<strong>Free Trial</strong>”).
</p> <p>
...
If you do enter your billing information when signing up for
				Free Trial, you will not be charged until Free Trial has
				...
				you have selected.
</p> <p>At any time and without notice, we reserve the right to:</p> <ol class="LegalList"> <li>modify Terms of Service of Free Trial offer, or</li> <li>cancel such Free Trial offer.</li> </ol> <h2 id="fee-changes">Fee Changes</h2> <p>
We, in our sole discretion and at any time, may modify
...
</p> <h2 id="refunds">Refunds</h2> <p>
We issue refunds for eligible paid contracts, subscriptions, or
				service purchases within fourteen (14) days of the original
				purchase, unless otherwise required by applicable law or stated
				in separate written terms for a specific offering.
</p> <h2 id="content">Content</h2> <p>
Our Service allows you to post, link, store, share and otherwise
				make available certain information, text, graphics, videos,
				code, configuration files, documents, or other material (“<strong>Content</strong>”). You are responsible for Content that you post on or through
...
that the posting of your Content on or through Service does
...
You retain any and all of your rights to any Content you submit,
				...
				you grant us the right and license to use, process, host,
				reproduce, adapt, modify, publicly perform, publicly display,
				and distribute such Content only as necessary to operate,
				maintain, improve, and provide Service features such as account
				management, sync, diagnostics, security, and support.
</p> <p>
You agree that this license includes the right for us to make
				your Content available to other users of Service where sharing
				or collaboration features are enabled by you, subject to these
				Terms.
</p> <p>
We have the right but not the obligation to monitor and edit all
				Content provided by users.
</p> <p>
In addition, Content found on or through this Service, excluding
				user-provided Content and code expressly released under an
				applicable open-source license such as CC0, is the property of
				Code Editor Land, PlayForm, its contributors, licensors, or is
				...
				without express advance written permission from us, except as
				permitted by the applicable license.
</p> <h2 id="prohibited-uses">Prohibited Uses</h2> <p>
...
f. To engage in any other conduct that restricts or inhibits
				...
				them to liability.
</p> <p>Additionally, you agree not to:</p> <p>
...
c. Use any manual process to monitor or copy any of the material
...
h. Take any action that may damage or falsify Company rating,
				reputation, service metrics, or analytics.
</p> <p>
i. Reverse engineer, decompile, or attempt to extract source
				code from proprietary backend infrastructure, Cloudflare
				Workers, APIs, or server-side systems except where such
				restriction is prohibited by law or where code is expressly made
				available under an open-source license.
</p> <p>
j. Otherwise attempt to interfere with the proper working of
				Service.
</p> <h2 id="no-use-by-minors">No Use by Minors</h2> <p>
Service is intended only for access and use by individuals at
				least eighteen (18) years old, unless a lower age is permitted
				by applicable law and use occurs with valid parental or guardian
				consent. By accessing or using any of Company, you warrant and
				represent that you are of sufficient legal age in your
				jurisdiction and with the full authority, right, and capacity to
				enter into this agreement and abide by all of the terms and
				conditions of Terms. If you do not meet these requirements, you
				are prohibited from access and usage of Service.
</p> <h2 id="accounts">Accounts</h2> <p>
...
Account creation and authentication is handled through
<strong>Auth0</strong>, a third-party identity platform operated
				by Okta. By creating an account, you agree to provide accurate
				identity information to Auth0 and acknowledge that Auth0's own
				terms and privacy policy apply to data processed during
				authentication. You may sign in using a social identity provider
				(GitHub, Google, GitLab, Okta, or Azure AD) subject to that
				provider's terms.
</p> <p>
We reserve the right to refuse service, terminate accounts,
				remove or edit content, or cancel orders in our sole discretion.
</p> <h2 id="intellectual-property">Intellectual Property</h2> <p>
Service and its original content (excluding Content provided by
				users and excluding code expressly released under open-source
				licenses), features and functionality are and will remain the
				exclusive property of Code Editor Land, PlayForm, and its
				licensors. Service is protected by copyright, trademark, and
				other laws of Bulgaria, the European Union, and foreign
				countries. Our trademarks and trade dress may not be used in
				connection with any product or service without the prior written
				consent of Code Editor Land or PlayForm, as applicable.
</p> <p>
The core editor codebase may be released under the
<a href="https://creativecommons.org/publicdomain/zero/1.0/" target="_blank" rel="noopener noreferrer">Creative Commons CC0 1.0 Universal</a>
license, which permits broad use, modification, and redistribution
				of code explicitly marked with that license. However, trademarks,
				logos, branding, design assets, documentation, and backend services
				remain protected unless we expressly state otherwise.
</p> <p>
The Service may also include third-party open-source components,
				extensions, libraries, and frameworks that remain subject to
				their own license terms. Your use of those materials is governed
				by the applicable third-party licenses.
</p> <h2 id="copyright-policy">Copyright Policy</h2> <p>
...
If you are a copyright owner, or authorized on behalf of one,
				...
				claim using the <a href="”/Contact/Claim”">Copyright &amp; DMCA form</a> (CLAIM) or by emailing <a href="”mailto:copyright@editor.land”">copyright@editor.land</a> or <a href="”mailto:legal@editor.land”">legal@editor.land</a> and include in your claim a detailed description of the alleged
...
You may be held accountable for damages (including costs and
				...
				on your copyright.
</p> <h2 id="dmca-notice-and-procedure-for-copyright-infringement-claims">
...
c. identification of the URL or other specific location on
				...
				located;
</p> <p>d. your address, telephone number, and email address;</p> <p>
...
You can contact our Copyright Agent using the <a href="/Contact/Claim">Copyright & DMCA form</a> (CLAIM) or by email at <a href="mailto:copyright@editor.land">copyright@editor.land</a>.
</p> <h2 id="error-reporting-and-feedback">
Error Reporting and Feedback
</h2> <p>
You may provide us via the <a href="/Contact/Scout">Technical Support form</a> (SCOUT), the <a href="/Contact/Hails">General Inquiry form</a> (HAILS),
				the <a href="/Contact/Legal">Legal Enquiry form</a> (LEGAL), or via
				our GitHub issue tracker, with information and feedback concerning
				errors, suggestions for improvements, ideas, problems, complaints,
				and other matters related to our Service (“<strong>Feedback</strong>”). You acknowledge and agree that:
</p> <p>
a) you shall not retain, acquire or assert any intellectual
				property right or other right, title or interest in or to the
				Feedback;
</p> <p>
b) Company may have development ideas similar to the Feedback;
</p> <p>
c) Feedback does not contain confidential information or
				proprietary information from you or any third party; and
</p> <p>
d) Company is not under any obligation of confidentiality with
...
</p> <h2 id="links-to-other-web-sites">Links To Other Web Sites</h2> <p>
Our Service may contain links to third-party web sites or
				services that are not owned or controlled by Code Editor Land or
				PlayForm.
</p> <p>
...
WE STRONGLY ADVISE YOU TO READ THE TERMS OF SERVICE AND PRIVACY
				...
				VISIT.
</p> <h2 id="disclaimer-of-warranty">Disclaimer Of Warranty</h2> <p>
...
</p> <h2 id="limitation-of-liability">Limitation Of Liability</h2> <p>
EXCEPT AS PROHIBITED BY LAW, YOU WILL HOLD US AND OUR OFFICERS,
				DIRECTORS, EMPLOYEES, CONTRIBUTORS, AND AGENTS HARMLESS FOR ANY
				INDIRECT, PUNITIVE, SPECIAL, INCIDENTAL, OR CONSEQUENTIAL
				DAMAGE, HOWEVER IT ARISES (INCLUDING ATTORNEYS' FEES AND ALL
				RELATED COSTS AND EXPENSES OF LITIGATION, ARBITRATION, OR AT
				...
				AGREEMENT AND ANY VIOLATION BY YOU OF ANY APPLICABLE LAWS,
...
EXCEPT AS PROHIBITED BY LAW, IF THERE IS LIABILITY FOUND ON THE
				PART OF COMPANY, IT WILL BE LIMITED TO THE GREATER OF THE AMOUNT
				PAID FOR THE PRODUCTS AND/OR SERVICES IN THE TWELVE (12) MONTHS
				PRIOR TO THE EVENT GIVING RISE TO THE CLAIM OR ONE HUNDRED
				DOLLARS ($100 USD), AND UNDER NO CIRCUMSTANCES WILL THERE BE
				CONSEQUENTIAL OR PUNITIVE DAMAGES.
</p> <p>
SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OR LIMITATION OF
				PUNITIVE, INCIDENTAL OR CONSEQUENTIAL DAMAGES, SO THE PRIOR
				LIMITATION OR EXCLUSION MAY NOT APPLY TO YOU.
</p> <h2 id="termination">Termination</h2> <p>
...
If you wish to terminate your account, you may simply
				discontinue using Service or request deletion through the <a href="/Contact/Erase">Account Deletion form</a> (ERASE) or by contacting <a href="mailto:support@editor.land">support@editor.land</a>.
</p> <p>
...
</p> <h2 id="governing-law">Governing Law</h2> <p>
These Terms shall be governed and construed in accordance with
				the laws of the Republic of Bulgaria without regard to its
...
</p> <h2 id="changes-to-service">Changes To Service</h2> <p>
...
</p> <h2 id="amendments-to-terms">Amendments To Terms</h2> <p>
...
By continuing to access or use our Service after any revisions
				...
				to use Service.
</p> <h2 id="waiver-and-severability">Waiver And Severability</h2> <p>
...
</p> <h2 id="acknowledgement">Acknowledgement</h2> <p>
...
By form: <a href="/Contact/Scout">Technical Support</a> (SCOUT), <a href="/Contact/Hails">General Inquiry</a> (HAILS), <a href="/Contact/Claim">Copyright</a> (CLAIM), <a href="/Contact/Legal">Legal</a> (LEGAL).
</p> <p>
By email: <a href="mailto:support@editor.land">support@editor.land</a>, <a href="mailto:legal@editor.land">legal@editor.land</a>, <a href="mailto:copyright@editor.land">copyright@editor.land</a>.
</p> <p>
By GitHub Issues:
...
</p> <p>By mail: PlayForm / Code Editor Land, Sofia, Bulgaria.</p> </article> <div class="LegalPrintHide mt-12 border-t pt-8"> <a href="#top" class="StaccatoButton text-primary hover:underline">Back to top<span class="InlineSeparator">↑</span></a> </div> </div> <script crossorigin=\"anonymous\" type="application/ld+json">
		{
...
var $$file = "/Volumes/CORSAIR/Developer/macOS/Application/CodeEditorLand/WebSite/Source/pages/Legal/Term.astro";
var $$url = "/Legal/Term";
//#endregion
//#region \0virtual:astro:page:Source/pages/Legal/Term@_@astro
var page = () => Term_exports;
//#endregion
export { page };
