const logo = "Land";
const nav$1 = {"features":"Fonctionnalités","download":"Télécharger","docs":"Documentation","blog":"Blog","contributing":"Contribuer","dashboard":"Tableau de bord","github":"GitHub"};
const actions = {"signIn":"Connexion","signUp":"Inscription","editorPortal":"Portail éditeur","getStarted":"Obtenir Land","logout":"Déconnexion","loading":"Chargement…"};
const user = {"avatarAlt":"Menu utilisateur","menu":{"dashboard":"Tableau de bord","account":"Compte","signOut":"Déconnexion"}};
const FrHeader = {
  logo,
  nav: nav$1,
  actions,
...
export { Doc$1 as D, EsHome as E, FrHeader as F, Header as H, Home as a };
