...
const GET = async () => {
  const GenerateOpenGraphSvg = (await import('./OpenGraph_Ibpu4DcJ.mjs').then(n => n.O)).default;
...
export { Doc as D, EsFooter as E, Footer as F, OpenGraph as O, PageMetadata$1 as P, Turbulence$1 as T, _noopMiddleware as _, EnDoc as a, _virtual_astro_sessionDriver$1 as b, _virtual_astro_serverIslandManifest as c, contentModules$1 as d, noopEntrypoint as n };
