...
import { c as cn, I as IconTooltip, E as ErrorBoundary, G as GetI18n, $ as $$Base } from './Base_DgX_hI0X.mjs';
import { H as Header } from './Header_D9EGRaC3.mjs';
import { a as SkeletonCard } from './Skeleton_D9Tf7O41.mjs';
import { D as DynamicPlatformGrid, B as Badge } from './Badge_BmXiAMSX.mjs';
import { useRef, useEffect } from 'react';
import { R as RichText } from './DynamicDocSidebar_CoCXJIn0.mjs';
import { D as DynamicButton } from './DynamicButton_Op41M-OY.mjs';
...
const DynamicVerificationInfo = ({
  ...
  const RenderVerificationBlock = (Information, Type) => /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
    ...
    Information.PGPSignature && /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
      ...
      Information.SigningKeyId && /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: T("labels.signedWithKeyId", {
    ...
    Information.VerificationInstructions && /* @__PURE__ */ jsxs("div", { className: "border-t border-[var(--Border)] pt-4", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "text-sm text-muted-foreground", children: /* @__PURE__ */ jsx(RichText, { Text: Information.VerificationInstructions }) })
    ] }),
  ...
  const ResolvedContent = Content || {
    PlatformGrid: {
      ...
      OnDownload: async (Platform) => {
        if (Platform.id) {
          try {
            const { default: DownloadAPI } = await import('./Download_BAWmv7GR.mjs');
            ...
            return /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  Item.Detail && /* @__PURE__ */ jsx("div", { className: "text-muted-foreground/70 text-xs", children: /* @__PURE__ */ jsx(
                    RichText,
                    {
                      Text: Item.Detail,
                      Terms: true
            ...
            return /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "StaccatoBreath text-muted-foreground", children: /* @__PURE__ */ jsx(RichText, { Text: Item.Description }) }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-baseline rounded-none border border-[var(--Border)] bg-secondary px-3 py-2 text-xs", children: [
...
Effect-TS&#x2001;<img src="/Image/EffectTS.svg" alt="" width="14" height="14" class="inline-block align-middle opacity-70" aria-hidden="true"> </span> <span class="inline-flex items-center border border-[var(--Border)] bg-[var(--Mute)] px-2.5 py-0.5 font-medium">
