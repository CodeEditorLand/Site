...
const description$1 = "L'éditeur de code de nouvelle génération";
...
const title = "E-Mail verifizieren";
const description = "Ein Verifizierungslink wurde gesendet an";
...
export { DeVerify as D, FrMeta as F, Meta as M, Verify as V };
