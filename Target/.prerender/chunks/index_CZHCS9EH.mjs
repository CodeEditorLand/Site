...
import 'piccolore';
import { w as renderComponent, B as renderTemplate, v as maybeRenderHead, e as Fragment$1, D as unescapeHTML } from './prerender_D05fJrym.mjs';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { useTranslation } from 'react-i18next';
import { I as IconTooltip, E as ErrorBoundary, G as GetI18n, $ as $$Base } from './Base_DNiQtfI8.mjs';
import { H as Header } from './Header_DYl-L_jZ.mjs';
import { b as SkeletonFeatureCard, c as SkeletonPricingTier, a as SkeletonCard } from './Skeleton_BLn2TtWP.mjs';
import * as lucide from 'lucide-react';
import { useRef, useEffect, useState } from 'react';
import { R as RichText } from './DynamicDocSidebar_BNJ18hBi.mjs';
import { B as Badge, D as DynamicPlatformGrid } from './Badge_GkEweVxN.mjs';
  ...
  const ResolvedContent = Content || {
    ...
    Download: {
      ...
      OnDownload: async (Platform) => {
        if (Platform.id) {
          try {
            const { default: DownloadAPI } = await import('./Download_C8aTkVoo.mjs');
