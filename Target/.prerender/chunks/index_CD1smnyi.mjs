...
import 'piccolore';
import { w as renderComponent, B as renderTemplate, v as maybeRenderHead, e as Fragment$1, D as unescapeHTML } from './prerender_DG8BZEWD.mjs';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { useTranslation } from 'react-i18next';
import { I as IconTooltip, E as ErrorBoundary, G as GetI18n, $ as $$Base } from './Base_C_b_uBI-.mjs';
import { H as Header } from './Header_CrTCyJxT.mjs';
import { b as SkeletonFeatureCard, c as SkeletonPricingTier, a as SkeletonCard } from './Skeleton_Dwa1wf52.mjs';
import * as lucide from 'lucide-react';
import { useRef, useEffect, useState } from 'react';
import { R as RichText } from './DynamicDocSidebar_BNJ18hBi.mjs';
import { B as Badge, D as DynamicPlatformGrid } from './Badge_LRolwn7S.mjs';
...
const DynamicFeatures = ({ Content, ClassName }) => {
  ...
  useEffect(() => {
    ...
    const ApplyScatter = async () => {
      ...
      const StaccatoModule = await import('./Staccato_BV9zPpMK.mjs');
  ...
  const ResolvedContent = Content || {
    ...
    Download: {
      ...
      OnDownload: async (Platform) => {
        if (Platform.id) {
          try {
            const { default: DownloadAPI } = await import('./Download_B7PX5pAj.mjs');
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "Title": MetaTitle, "Description": MetaDescription, "lang": "en" }, { "Head": ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment$1, { "slot": "Head" }, { "default": ($$result3) => renderTemplate(_a || (_a = __template([' <script crossorigin=\"anonymous\" type="application/ld+json">', "<\/script> "])), unescapeHTML(JSON.stringify({
    ...
    "screenshot": "https://land.playform.cloud/Favicon/og-image.png",
    "author": [
      {
        "@type": "Person",
...
PlayForm
</a> <a href="https://land.playform.cloud" class="inline-flex items-center bg-[var(--Mute)] px-2.5 py-0.5 font-medium transition-colors hover:text-foreground">
CodeEditorLand
</a> </div> ` })}`;
