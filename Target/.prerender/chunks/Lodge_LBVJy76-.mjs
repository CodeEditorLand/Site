...
//#region Source/pages/Contact/Lodge.astro
var Lodge_exports = /* @__PURE__ */ __exportAll({
	default: () => $$Lodge,
	file: () => $$file,
	url: () => $$url
});
createAstro("https://editor.land");
var $$Lodge = createComponent(async ($$result, $$props, $$slots) => {
...
var $$file = "/Volumes/CORSAIR/Developer/macOS/Application/CodeEditorLand/WebSite/Source/pages/Contact/Lodge.astro";
var $$url = "/Contact/Lodge";
//#endregion
//#region \0virtual:astro:page:Source/pages/Contact/Lodge@_@astro
var page = () => Lodge_exports;
//#endregion
export { page };
