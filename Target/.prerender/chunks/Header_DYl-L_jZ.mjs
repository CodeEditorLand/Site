...
import { c as cn, I as IconTooltip } from './Base_DNiQtfI8.mjs';
...
const CoreLocaleLoader = {
  en: async () => ({
    ...
    header: (await import('./PageMetadata_DCR0Ql3-.mjs').then(n => n.H)).default,
...
const FullLocaleLoader = {
  en: async () => ({
    blog: (await import('./OpenGraph_z60FvhhY.mjs').then(n => n.B)).default,
    common: (await import('./Common_B5Tpd7O0.mjs')).default,
    doc: (await import('./PageMetadata_DCR0Ql3-.mjs').then(n => n.d)).default,
  ...
  bg: async () => ({
    ...
    common: (await import('./Common_BqcJAYVG.mjs')).default,
    doc: (await import('./PageMetadata_DCR0Ql3-.mjs').then(n => n.e)).default,
  ...
  fr: async () => ({
    ...
    common: (await import('./Common_BcevmFMg.mjs')).default,
    doc: (await import('./PageMetadata_DCR0Ql3-.mjs').then(n => n.f)).default,
