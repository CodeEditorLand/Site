...
const GET = async ({ params }) => {
  ...
  const PageMetadata = (await import('./Turbulence_MCudHMuZ.mjs').then(n => n.P)).default;
  ...
  if (Slug.startsWith("Blog/")) {
    ...
    try {
      const { getCollection } = await import('./_astro_content_QVNE1-hI.mjs');
...
export { Blog as B, DEFAULT_OUTPUT_FORMAT as D, EnBlog as E, OpenGraph as O, VALID_INPUT_FORMATS as V, ____Slug_ as _, VALID_SUPPORTED_FORMATS as a, DEFAULT_HASH_PROPS as b, Doc$1 as c, contentAssets$1 as d };
