...
import 'piccolore';
import { r as renderComponent, a as renderTemplate, m as maybeRenderHead, F as Fragment$1, u as unescapeHTML } from './prerender_B86tonbF.mjs';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { useTranslation } from 'react-i18next';
import { H as Header } from './Header_CX6MMaW-.mjs';
import { Sparkles, Database, Shield, Server, Puzzle, Package, Layers, Code, Heart, Wrench, Globe, Cpu, Box, Zap, Network, Check } from 'lucide-react';
import { useRef, useEffect, useState } from 'react';
import { I as IconTooltip } from './IconTooltip_Ckyq-lve.mjs';
import { B as Badge, D as DynamicPlatformGrid } from './Badge_DHJgxaOk.mjs';
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative mx-auto max-w-5xl", "aria-hidden": "true", children: [
          /* @__PURE__ */ jsx("div", { className: "flex flex-wrap items-center justify-center gap-3 lg:hidden", children: FloatingCard.map((Card, Index) => {
            const GetIcon = () => {
              ...
              if (Title2.includes("rust") || Title2.includes("core")) return Cpu;
              if (Title2.includes("tauri") || Title2.includes("ui")) return Box;
              if (Title2.includes("effect") || Title2.includes("service")) return Layers;
              if (Title2.includes("grpc") || Title2.includes("ipc")) return Network;
              if (Title2.includes("extension")) return Puzzle;
              if (Title2.includes("cross") || Title2.includes("platform")) return Globe;
              if (Title2.includes("vs code") || Title2.includes("api")) return Server;
              if (Title2.includes("open") || Title2.includes("source")) return Zap;
              return Cpu;
            };
            ...
            return /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "mb-2 flex items-center justify-center", children: /* @__PURE__ */ jsx(IconComponent, { className: "h-6 w-6 text-primary" }) }),
                  /* @__PURE__ */ jsx("div", { className: "text-center", children: /* @__PURE__ */ jsx("div", { className: "text-xs font-medium text-foreground", children: Card.title }) })
                ]
              },
              Card.id
            );
                ...
                FloatingCard.map((Card, Index) => {
                  ...
                  return /* @__PURE__ */ jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsx("div", { className: "mb-2 flex items-center justify-center", children: /* @__PURE__ */ jsx(IconComponent, { className: "h-8 w-8 text-primary" }) }),
                        /* @__PURE__ */ jsx("div", { className: "text-center", children: /* @__PURE__ */ jsx("div", { className: "text-xs font-medium text-foreground", children: Card.title }) })
                      ]
                    },
                    Card.id
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
        ...
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: testimonials.map((Testimonial) => /* @__PURE__ */ jsxs(
              "article",
              {
