...
<a href="https://editor.land">https://editor.land</a>, our
				desktop application, APIs, Cloudflare Workers, documentation,
				downloads, account services, synchronization features, and any
				related services (together or individually “<strong>Service</strong>”) operated by PlayForm, based in Sofia, Bulgaria, as steward
...
If you do not agree with (or cannot comply with) Agreements,
				...
				emailing <a href="mailto:legal@editor.land">legal@editor.land</a>
...
By creating an account on our Service, you agree to subscribe to
				...
				or by emailing <a href="mailto:support@editor.land">support@editor.land</a>.
...
</p> <p>You represent and warrant that:</p> <p>
a) you have the legal right to use any credit card(s) or other
				payment method(s) in connection with any Purchase; and
</p> <p>
b) the information you supply to us is true, correct and
				complete.
</p> <p>
...
At any time and without notice, we reserve the right to a)
				modify Terms of Service of Free Trial offer, or b) cancel such
				Free Trial offer.
</p> <h2 id="fee-changes">Fee Changes</h2> <p>
...
a) Content is yours (you own it) and/or you have the right to
				use it and the right to grant us the rights and license as
				provided in these Terms; and
</p> <p>
b) that the posting of your Content on or through Service does
...
If you are a copyright owner, or authorized on behalf of one,
				...
				claim via email to
<a href="mailto:copyright@editor.land">copyright@editor.land</a>
or <a href="mailto:legal@editor.land">legal@editor.land</a>,
				with the subject line: “<strong>Copyright Infringement</strong>”
				and include in your claim a detailed description of the alleged
				Infringement as detailed below, under “DMCA Notice and Procedure
...
<a href="mailto:legal@editor.land">legal@editor.land</a>, or via
				third-party sites and tools including our GitHub issue tracker,
...
If you wish to terminate your account, you may simply
				discontinue using Service or request deletion through account
...
By email:
<a href="mailto:support@editor.land">support@editor.land</a>,
<a href="mailto:legal@editor.land">legal@editor.land</a>,
<a href="mailto:copyright@editor.land">copyright@editor.land</a>.
</p> <p>
By GitHub Issues:
...
</p> <p>By mail: PlayForm / Code Editor Land, Sofia, Bulgaria.</p> </article> <div class="mt-12 border-t pt-8"> <a href="#top" class="StaccatoButton text-sm text-primary hover:underline">Back to top<span class="InlineSeparator">↑</span></a> </div> </div> <script crossorigin=\"anonymous\" type="application/ld+json">
		{
