...
import 'piccolore';
import { w as renderComponent, B as renderTemplate, v as maybeRenderHead, n as addAttribute } from './prerender_D05fJrym.mjs';
import { getCollection } from './_astro_content_DP53QPvx.mjs';
...
Rust API
  ...
  })} </p> <div class="grid grid-cols-1 gap-3 md:grid-cols-2"> <a href="/" target="_blank" rel="noopener noreferrer" class="block bg-white px-4 py-3 transition-colors hover:bg-[var(--Secondary)]"> <span class="font-semibold">${T("common.docs.deployments.website", {
