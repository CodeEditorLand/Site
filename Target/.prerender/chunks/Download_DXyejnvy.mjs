import { a as cn, c as createComponent, G as GetI18n, $ as $$Base } from './Base_Czy5kkbA.mjs';
import 'piccolore';
...
import { D as DynamicPlatformGrid, B as Badge } from './Badge_qZeVDWIC.mjs';
...
const DynamicSystemRequirements = ({ content, className }) => {
  ...
  const RequirementList = ({
    ...
    " ",
    /* @__PURE__ */ jsx("div", { className: "mt-1 shrink-0", children: Variant === "minimum" ? /* @__PURE__ */ jsx(lucide.Cpu, { className: "h-4 w-4 text-muted-foreground" }) : /* @__PURE__ */ jsx(lucide.Monitor, { className: "h-4 w-4 text-muted-foreground" }) })
  ] }, Requirement.id)) });
  return /* @__PURE__ */ jsx(
    "section",
    {
        ...
        SourceURL && /* @__PURE__ */ jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxs(
          "a",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "InlineSeparator", children: /* @__PURE__ */ jsx(lucide.Code, { className: "h-4 w-4", "aria-hidden": "true" }) })
            ]
          }
        ) })
      ] })
