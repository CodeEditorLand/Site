...
import { c as cn, I as IconTooltip } from './Base_DgX_hI0X.mjs';
...
const CoreLocaleLoader = {
  ...
  es: async () => ({
    ...
    footer: (await import('./Turbulence_MCudHMuZ.mjs').then(n => n.F)).default,
    meta: (await import('./Meta_hHADzK8O.mjs').then(n => n.a)).default
  })
};
const FullLocaleLoader = {
  en: async () => ({
    blog: (await import('./OpenGraph_Ibpu4DcJ.mjs').then(n => n.B)).default,
    common: (await import('./Common_7T26dmWX.mjs')).default,
    doc: (await import('./Turbulence_MCudHMuZ.mjs').then(n => n.D)).default,
  ...
  bg: async () => ({
    ...
    common: (await import('./Common_BqcJAYVG.mjs')).default,
    doc: (await import('./OpenGraph_Ibpu4DcJ.mjs').then(n => n.c)).default,
