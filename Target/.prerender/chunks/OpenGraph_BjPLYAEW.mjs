...
const GET = async ({ params }) => {
  ...
  const PageMetadata = (await import('./PageMetadata_DYW59jf6.mjs').then(n => n.P)).default;
  ...
  if (Slug.startsWith("Blog/")) {
    ...
    try {
      const { getCollection } = await import('./_astro_content_Bn0Y5TxG.mjs');
...
export { Blog as B, EnBlog as E, OpenGraph as O, ____Slug_ as _, _noopMiddleware as a, _virtual_astro_serverIslandManifest as b, _virtual_astro_sessionDriver$1 as c, contentModules$1 as d, noopEntrypoint as n };
