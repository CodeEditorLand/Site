...
import { c as cn, I as IconTooltip } from './Base_BgDg_fIU.mjs';
...
const CoreLocaleLoader = {
  en: async () => ({
    ...
    header: (await import('./PageMetadata_DYW59jf6.mjs').then(n => n.H)).default,
    footer: (await import('./Home_BwaCdcQj.mjs').then(n => n.F)).default,
    meta: (await import('./Verify_CEfXaH2C.mjs').then(n => n.M)).default
  }),
  bg: async () => ({
    common: (await import('./Common_BqcJAYVG.mjs')).default,
    header: (await import('./Doc_upvpGoFM.mjs').then(n => n.H)).default,
    footer: (await import('./Blog_BJ75-13H.mjs').then(n => n.F)).default,
    meta: (await import('./Meta_hHADzK8O.mjs').then(n => n.M)).default
  }),
  de: async () => ({
    common: (await import('./Common_RDgAMe-1.mjs')).default,
    header: (await import('./Doc_CGmzPUkD.mjs').then(n => n.H)).default,
    footer: (await import('./Verify_REInX2eZ.mjs').then(n => n.F)).default,
    meta: (await import('./Verify_D63uTEAh.mjs').then(n => n.M)).default
  }),
  fr: async () => ({
    common: (await import('./Common_BcevmFMg.mjs')).default,
    header: (await import('./Account_B9kC2AMl.mjs').then(n => n.H)).default,
    footer: (await import('./Verify_REInX2eZ.mjs').then(n => n.a)).default,
    meta: (await import('./Verify_SYGfOzvI.mjs').then(n => n.M)).default
  }),
  es: async () => ({
    common: (await import('./Common_vX1rs6M9.mjs')).default,
    header: (await import('./Home_ktMVnhLc.mjs').then(n => n.H)).default,
    footer: (await import('./Turbulence_BT9qYdjt.mjs').then(n => n.F)).default,
    meta: (await import('./Meta_hHADzK8O.mjs').then(n => n.a)).default
  })
};
const FullLocaleLoader = {
  en: async () => ({
    blog: (await import('./OpenGraph_BjPLYAEW.mjs').then(n => n.B)).default,
    common: (await import('./Common_B5Tpd7O0.mjs')).default,
    doc: (await import('./PageMetadata_DYW59jf6.mjs').then(n => n.d)).default,
    home: (await import('./Home_D1bEzr6B.mjs')).default,
    download: (await import('./Download_Bei4lrNM.mjs').then(n => n.D)).default,
    account: (await import('./Doc_upvpGoFM.mjs').then(n => n.A)).default,
  ...
  bg: async () => ({
    blog: (await import('./Account_B9kC2AMl.mjs').then(n => n.B)).default,
    common: (await import('./Common_BqcJAYVG.mjs')).default,
    doc: (await import('./PageMetadata_DYW59jf6.mjs').then(n => n.e)).default,
    home: (await import('./Turbulence_BT9qYdjt.mjs').then(n => n.H)).default,
    download: (await import('./Download_Bei4lrNM.mjs').then(n => n.a)).default,
    account: (await import('./Doc_CGmzPUkD.mjs').then(n => n.A)).default,
  ...
  de: async () => ({
    blog: (await import('./Home_ktMVnhLc.mjs').then(n => n.B)).default,
    common: (await import('./Common_RDgAMe-1.mjs')).default,
    doc: (await import('./Doc_upvpGoFM.mjs').then(n => n.D)).default,
    home: (await import('./Home_ktMVnhLc.mjs').then(n => n.a)).default,
    download: (await import('./Download_Ck1ZgmMa.mjs').then(n => n.a)).default,
    account: (await import('./Account_B9kC2AMl.mjs').then(n => n.A)).default,
  ...
  fr: async () => ({
    blog: (await import('./Home_BwaCdcQj.mjs').then(n => n.B)).default,
    common: (await import('./Common_BcevmFMg.mjs')).default,
    doc: (await import('./PageMetadata_DYW59jf6.mjs').then(n => n.f)).default,
    home: (await import('./Home_Bs5JpymL.mjs')).default,
    download: (await import('./Download_DFvhDwcB.mjs').then(n => n.D)).default,
    account: (await import('./Blog_BJ75-13H.mjs').then(n => n.A)).default,
  ...
  es: async () => ({
    blog: (await import('./Blog_BJ75-13H.mjs').then(n => n.a)).default,
    common: (await import('./Common_vX1rs6M9.mjs')).default,
    doc: (await import('./Doc_CGmzPUkD.mjs').then(n => n.a)).default,
    home: (await import('./Home_BwaCdcQj.mjs').then(n => n.H)).default,
    download: (await import('./Download_Ck1ZgmMa.mjs').then(n => n.b)).default,
    account: (await import('./Account_D2JkIviN.mjs')).default,
    verify: (await import('./Verify_REInX2eZ.mjs').then(n => n.V)).default,
    header: (await import('./Home_ktMVnhLc.mjs').then(n => n.H)).default,
    footer: (await import('./Turbulence_BT9qYdjt.mjs').then(n => n.F)).default,
    meta: (await import('./Meta_hHADzK8O.mjs').then(n => n.a)).default
  })
