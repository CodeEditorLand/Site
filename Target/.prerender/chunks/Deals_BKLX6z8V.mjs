...
//#region Source/pages/Contact/Deals.astro
var Deals_exports = /* @__PURE__ */ __exportAll({
	default: () => $$Deals,
	file: () => $$file,
	url: () => $$url
});
createAstro("https://editor.land");
var $$Deals = createComponent(async ($$result, $$props, $$slots) => {
...
var $$file = "/Volumes/CORSAIR/Developer/macOS/Application/CodeEditorLand/WebSite/Source/pages/Contact/Deals.astro";
var $$url = "/Contact/Deals";
//#endregion
//#region \0virtual:astro:page:Source/pages/Contact/Deals@_@astro
var page = () => Deals_exports;
//#endregion
export { page };
