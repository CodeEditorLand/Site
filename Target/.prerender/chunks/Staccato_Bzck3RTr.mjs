const Staccato = (async () => {
  ...
  const Config = (await import('./Noise_DNfSD_2m.mjs')).default;
  const Turbulence = (await import('./Turbulence_Befh_LQB.mjs').then(n => n.T)).default;
  const ParallaxModule = (await import('./Parallax_CxMoNu1O.mjs').then(n => n.P)).default;
