...
import { c as cn, I as IconTooltip } from './Base_BbbN-lWJ.mjs';
...
const CoreLocaleLoader = {
  ...
  fr: async () => ({
    ...
    footer: (await import('./Turbulence_YRmMp-rm.mjs').then(n => n.F)).default,
...
const FullLocaleLoader = {
  en: async () => ({
    blog: (await import('./OpenGraph_BCmYe4V8.mjs').then(n => n.B)).default,
    common: (await import('./Common_B5Tpd7O0.mjs')).default,
    doc: (await import('./Turbulence_YRmMp-rm.mjs').then(n => n.D)).default,
