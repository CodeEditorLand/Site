...
import { I as IconTooltip } from './Base_DGQ8XLTY.mjs';
...
const LocaleLoader = {
  en: async () => ({
    ...
    download: (await import('./_virtual_astro_server-island-manifest_BZDX48GE.mjs').then(n => n.c)).default,
    account: (await import('./Account_CALsxJvd.mjs')).default,
    verify: (await import('./_virtual_astro_server-island-manifest_BZDX48GE.mjs').then(n => n.V)).default,
    header: (await import('./Meta_BwDJIdGz.mjs').then(n => n.H)).default,
    footer: (await import('./Parallax_Cjag1fPN.mjs').then(n => n.F)).default,
  ...
  bg: async () => ({
    ...
    download: (await import('./Parallax_Cjag1fPN.mjs').then(n => n.D)).default,
  ...
  de: async () => ({
    ...
    download: (await import('./Turbulence_Cm16QnZB.mjs').then(n => n.a)).default,
    account: (await import('./Account_6oWojYfO.mjs')).default,
    verify: (await import('./Verify_BEAbsfy7.mjs').then(n => n.V)).default,
    header: (await import('./_virtual_astro_server-island-manifest_BZDX48GE.mjs').then(n => n.H)).default,
  ...
  fr: async () => ({
    ...
    download: (await import('./Turbulence_Cm16QnZB.mjs').then(n => n.b)).default,
  ...
  es: async () => ({
    ...
    download: (await import('./Turbulence_Cm16QnZB.mjs').then(n => n.c)).default,
    account: (await import('./Account_I3HxFODb.mjs')).default,
    verify: (await import('./Verify_BEAbsfy7.mjs').then(n => n.a)).default,
    header: (await import('./_virtual_astro_server-island-manifest_BZDX48GE.mjs').then(n => n.d)).default,
    footer: (await import('./Parallax_Cjag1fPN.mjs').then(n => n.b)).default,
