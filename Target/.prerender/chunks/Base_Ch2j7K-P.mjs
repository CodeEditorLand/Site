...
var $$Base = createComponent(($$result, $$props, $$slots) => {
	...
	}))}<\/script>${renderSlot($$result, $$slots["Head"])}<!-- Favicon --><link rel="icon" type="image/png" href="/Favicon/favicon-96x96.png" sizes="96x96"><link rel="icon" type="image/svg+xml" href="/Favicon/favicon.svg"><link rel="shortcut icon" href="/Favicon/favicon.ico"><link rel="apple-touch-icon" sizes="180x180" href="/Favicon/apple-touch-icon.png"><meta name="apple-mobile-web-app-title" content="Code Editor Land"><link rel="manifest" href="/Favicon/site.webmanifest"><!-- Jelly UI — bundled by Vite from local Vendor/JellyUI package.
		     Imported as a module so Vite tree-shakes and content-hashes it
		     automatically. --><script crossorigin=\"anonymous\" type="module" src="/jelly.js"><\/script>${renderHead($$result)}</head> <body> <a href="#main-content" class="sr-only fixed left-2 top-2 z-[100] -translate-y-full bg-primary px-4 py-2 font-medium text-primary-fg transition-transform focus:not-sr-only focus:translate-y-0 focus:outline-2 focus:outline-offset-2 focus:outline-[var(--Primary)]">
