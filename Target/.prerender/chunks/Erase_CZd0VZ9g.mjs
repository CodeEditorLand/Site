...
import { t as $$Base } from "./Base_DSZ6CS4q.mjs";
...
//#region Source/pages/Contact/Erase.astro
var Erase_exports = /* @__PURE__ */ __exportAll({
	default: () => $$Erase,
	file: () => $$file,
	url: () => $$url
});
createAstro("https://editor.land");
var $$Erase = createComponent(async ($$result, $$props, $$slots) => {
...
var $$file = "/Volumes/CORSAIR/Developer/macOS/Application/CodeEditorLand/WebSite/Source/pages/Contact/Erase.astro";
var $$url = "/Contact/Erase";
//#endregion
//#region \0virtual:astro:page:Source/pages/Contact/Erase@_@astro
var page = () => Erase_exports;
//#endregion
export { page };
