...
//#region Source/pages/Contact/Reach.astro
var Reach_exports = /* @__PURE__ */ __exportAll({
	default: () => $$Reach,
	file: () => $$file,
	url: () => $$url
});
createAstro("https://editor.land");
var $$Reach = createComponent(async ($$result, $$props, $$slots) => {
...
var $$file = "/Volumes/CORSAIR/Developer/macOS/Application/CodeEditorLand/WebSite/Source/pages/Contact/Reach.astro";
var $$url = "/Contact/Reach";
//#endregion
//#region \0virtual:astro:page:Source/pages/Contact/Reach@_@astro
var page = () => Reach_exports;
//#endregion
export { page };
