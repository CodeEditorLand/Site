...
import { c as cn, I as IconTooltip } from './Base_C_b_uBI-.mjs';
...
const CoreLocaleLoader = {
  ...
  fr: async () => ({
    ...
    footer: (await import('./Turbulence_qp3DVTah.mjs').then(n => n.F)).default,
...
const FullLocaleLoader = {
  en: async () => ({
    blog: (await import('./OpenGraph_m_taqD86.mjs').then(n => n.B)).default,
    common: (await import('./Common_B5Tpd7O0.mjs')).default,
    doc: (await import('./Turbulence_qp3DVTah.mjs').then(n => n.D)).default,
