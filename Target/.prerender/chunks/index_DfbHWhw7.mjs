...
import 'piccolore';
import { r as renderComponent, a as renderTemplate, m as maybeRenderHead, F as Fragment$1, u as unescapeHTML } from './prerender_SnvtGgzS.mjs';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { useTranslation } from 'react-i18next';
import { H as Header } from './Header_y9oh1c8T.mjs';
import * as lucide from 'lucide-react';
import { useRef, useEffect, useState } from 'react';
import { I as IconTooltip } from './IconTooltip_hF15gFK_.mjs';
import { B as Badge, D as DynamicPlatformGrid } from './Badge_qZeVDWIC.mjs';
import { D as DynamicButton } from './DynamicButton_Kou3RZs8.mjs';
  ...
  const ResolvedContent = content || {
    ...
    download: {
      ...
      onDownload: async (Platform) => {
        if (Platform.id) {
          try {
            const { default: DownloadAPI } = await import('./Download_lxhLY5Fx.mjs');
