...
import { B as Button, H as Header } from './Header_D9EGRaC3.mjs';
import { C as Card, a as CardHeader, b as CardTitle, d as CardContent } from './Card_DLqtJO_1.mjs';
import { I as IconTooltip, G as GetI18n, $ as $$Base } from './Base_DgX_hI0X.mjs';
import { D as DynamicInput } from './DynamicInput_BY4tmL1z.mjs';
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "PortalTierLogin", children: /* @__PURE__ */ jsxs(Card, { className: "PortalTierCard", children: [
          /* @__PURE__ */ jsx(CardHeader, { className: "PortalTierCardHeader", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            ...
            StatusLabel && /* @__PURE__ */ jsx("span", { className: "StaccatoBadge border border-[var(--Border)] bg-[var(--Mute)] px-2 py-0.5 text-xs font-medium text-muted-foreground", children: StatusLabel }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "PortalTierFeatureList", children: [
            ...
            /* @__PURE__ */ jsx("ul", { className: "PortalTierFeatureItems", children: Content.Feature.map((Feature, FeatureIndex) => /* @__PURE__ */ jsxs(
              "li",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxs("span", { className: "flex flex-wrap items-center gap-2 text-sm font-medium", children: [
                    Feature.Heading,
                    (Feature.Status ?? Content.Status) && (Feature.Status ?? Content.Status) !== "Ready" && /* @__PURE__ */ jsx("span", { className: "StaccatoBadge border border-[var(--Border)] bg-[var(--Mute)] px-2 py-0.5 text-xs font-medium text-muted-foreground", children: (Feature.Status ?? Content.Status) === "WIP" ? "WIP" : "Coming Soon" })
                  ] }),
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    StatusLabel && /* @__PURE__ */ jsxs(Fragment, { children: [
                      " ",
                      /* @__PURE__ */ jsx("span", { className: "StaccatoBadge border border-[var(--Border)] bg-[var(--Mute)] px-2 py-0.5 text-xs font-medium text-muted-foreground", children: StatusLabel })
                    ] }),
                    " ",
                    /* @__PURE__ */ jsx(
                      IconTooltip,
...
const DynamicPortal = ({ Content }) => {
  ...
  useEffect(() => {
    ...
    const StartNoise = async () => {
      const StaccatoModule = await import('./Staccato_CRLLSS8d.mjs');
...
const $$Portal = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "Title": MetaTitle, "Description": MetaDescription }, { "default": ($$result2) => renderTemplate`  ${renderComponent($$result2, "Header", Header, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Volumes/CORSAIR/Developer/macOS/Application/CodeEditorLand/WebSite/Source/Component/Layout/Header", "client:component-export": "Header" })} ${maybeRenderHead()}<main id="main-content"> <!-- Breadcrumb --> <nav aria-label="Breadcrumb" class="container mx-auto px-4 pt-6 text-sm text-muted-foreground"> <ol class="flex flex-wrap items-center space-x-2"> <li> <a href="/" class="transition-colors hover:text-foreground"> ${T("common.breadcrumb.home", { defaultValue: "Home" })} </a> </li> <li class="mx-2">/</li> <li> <span class="font-medium text-foreground"> ${T("meta.portal.breadcrumb", {
    defaultValue: "Portal"
  })} </span> </li> </ol> </nav> <div class="container mx-auto flex flex-wrap items-center justify-center gap-3 px-4 pt-6 text-xs text-muted-foreground"> <picture> <img alt="Land" src="/Asset/Logo/Glyph/Land.svg" width="28" height="28"> </picture> <span class="inline-flex items-center border border-green-200 bg-green-50 px-2.5 py-0.5 font-medium text-green-700">
...
OIDC / SAML / Okta Planned&#x2001;<span class="h-1.5 w-1.5 rounded-none bg-green-500" aria-hidden="true"></span> </span> <a href="https://PlayForm.Cloud" target="_blank" rel="noopener noreferrer" class="inline-flex items-center border border-[var(--Border)] bg-[var(--Mute)] px-2.5 py-0.5 font-medium transition-colors hover:text-foreground">
PlayForm
