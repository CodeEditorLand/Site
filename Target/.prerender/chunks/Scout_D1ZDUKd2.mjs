...
//#region Source/pages/Contact/Scout.astro
var Scout_exports = /* @__PURE__ */ __exportAll({
	default: () => $$Scout,
	file: () => $$file,
	url: () => $$url
});
createAstro("https://editor.land");
var $$Scout = createComponent(async ($$result, $$props, $$slots) => {
...
var $$file = "/Volumes/CORSAIR/Developer/macOS/Application/CodeEditorLand/WebSite/Source/pages/Contact/Scout.astro";
var $$url = "/Contact/Scout";
//#endregion
//#region \0virtual:astro:page:Source/pages/Contact/Scout@_@astro
var page = () => Scout_exports;
//#endregion
export { page };
