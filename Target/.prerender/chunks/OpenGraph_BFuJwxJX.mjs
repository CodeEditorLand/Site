...
const GET = async ({ params }) => {
  ...
  const PageMetadata = (await import('./Turbulence_Be3bv8bE.mjs').then(n => n.P)).default;
  ...
  if (Slug.startsWith("Blog/")) {
    ...
    try {
      const { getCollection } = await import('./_astro_content_Do7_53PI.mjs');
...
export { Blog as B, DEFAULT_OUTPUT_FORMAT as D, EnBlog as E, OpenGraph as O, VALID_INPUT_FORMATS as V, ____Slug_ as _, VALID_SUPPORTED_FORMATS as a, DEFAULT_HASH_PROPS as b, Doc$1 as c, contentModules$1 as d };
