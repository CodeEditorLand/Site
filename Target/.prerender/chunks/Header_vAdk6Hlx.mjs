...
import { c as cn, I as IconTooltip } from './Base_IAktlLoN.mjs';
...
const ButtonVariants = cva(
  "inline-flex items-center justify-center gap-0 whitespace-nowrap border text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-[var(--Ring)] focus-visible:ring-[var(--Ring)]/50 focus-visible:ring-[1px] aria-invalid:ring-[var(--Destruct)]/20 aria-invalid:border-[var(--Destruct)]",
  {
    variants: {
      variant: {
        default: "bg-[var(--Primary)] text-[var(--PrimaryForeground)] hover:opacity-90",
        destructive: "bg-[var(--Destruct)] text-white hover:opacity-90 focus-visible:ring-[var(--Destruct)]/20",
        outline: "border border-[var(--Border)] bg-[var(--Background)] text-[var(--Foreground)] hover:bg-[var(--Secondary)] hover:text-[var(--SecondaryForeground)]",
        secondary: "bg-[var(--Secondary)] text-[var(--SecondaryForeground)] hover:opacity-80",
...
const CoreLocaleLoader = {
  en: async () => ({
    common: (await import('./Common_7T26dmWX.mjs')).default,
    header: (await import('./Doc_100FnmU2.mjs').then(n => n.H)).default,
    footer: (await import('./Blog_Dtxov0aj.mjs').then(n => n.F)).default,
    meta: (await import('./Verify_CEfXaH2C.mjs').then(n => n.M)).default
  }),
  bg: async () => ({
    common: (await import('./Common_BqcJAYVG.mjs')).default,
    header: (await import('./Home_DN_-k5Pn.mjs').then(n => n.H)).default,
    footer: (await import('./Blog_CU19LiaO.mjs').then(n => n.F)).default,
    meta: (await import('./Meta_hHADzK8O.mjs').then(n => n.M)).default
  }),
  de: async () => ({
    common: (await import('./Common_RDgAMe-1.mjs')).default,
    header: (await import('./Doc_8A8AkYjO.mjs').then(n => n.H)).default,
    footer: (await import('./Verify_TPb8E8qQ.mjs').then(n => n.a)).default,
    meta: (await import('./Verify_D63uTEAh.mjs').then(n => n.M)).default
  }),
  fr: async () => ({
    common: (await import('./Common_BcevmFMg.mjs')).default,
    header: (await import('./Blog_B3Ra7uKu.mjs').then(n => n.H)).default,
    footer: (await import('./Verify_TPb8E8qQ.mjs').then(n => n.b)).default,
    meta: (await import('./Verify_SYGfOzvI.mjs').then(n => n.M)).default
  }),
  es: async () => ({
    common: (await import('./Common_vX1rs6M9.mjs')).default,
    header: (await import('./Home_CvAKDKAw.mjs').then(n => n.H)).default,
    footer: (await import('./Turbulence_Be3bv8bE.mjs').then(n => n.F)).default,
    meta: (await import('./Meta_hHADzK8O.mjs').then(n => n.a)).default
  })
};
const FullLocaleLoader = {
  en: async () => ({
    blog: (await import('./OpenGraph_BFuJwxJX.mjs').then(n => n.B)).default,
    common: (await import('./Common_7T26dmWX.mjs')).default,
    doc: (await import('./Turbulence_Be3bv8bE.mjs').then(n => n.D)).default,
    home: (await import('./Home_k9bW8u7n.mjs')).default,
    download: (await import('./Download_DRiguKPK.mjs').then(n => n.D)).default,
    account: (await import('./Blog_B3Ra7uKu.mjs').then(n => n.A)).default,
  ...
  bg: async () => ({
    blog: (await import('./Blog_B3Ra7uKu.mjs').then(n => n.B)).default,
    common: (await import('./Common_BqcJAYVG.mjs')).default,
    doc: (await import('./OpenGraph_BFuJwxJX.mjs').then(n => n.c)).default,
    home: (await import('./Doc_8A8AkYjO.mjs').then(n => n.a)).default,
    download: (await import('./Download_DRiguKPK.mjs').then(n => n.a)).default,
    account: (await import('./Blog_CU19LiaO.mjs').then(n => n.A)).default,
  ...
  de: async () => ({
    blog: (await import('./Home_CvAKDKAw.mjs').then(n => n.B)).default,
    common: (await import('./Common_RDgAMe-1.mjs')).default,
    doc: (await import('./Home_DN_-k5Pn.mjs').then(n => n.D)).default,
    home: (await import('./Doc_100FnmU2.mjs').then(n => n.a)).default,
    download: (await import('./Download_Ck1ZgmMa.mjs').then(n => n.a)).default,
    account: (await import('./Blog_Dtxov0aj.mjs').then(n => n.A)).default,
  ...
  fr: async () => ({
    blog: (await import('./Blog_Dtxov0aj.mjs').then(n => n.B)).default,
    common: (await import('./Common_BcevmFMg.mjs')).default,
    doc: (await import('./Doc_100FnmU2.mjs').then(n => n.b)).default,
    home: (await import('./Home_CvAKDKAw.mjs').then(n => n.a)).default,
    download: (await import('./Download_DFvhDwcB.mjs').then(n => n.D)).default,
    account: (await import('./Account_D2gYkc1x.mjs')).default,
  ...
  es: async () => ({
    blog: (await import('./Blog_CU19LiaO.mjs').then(n => n.b)).default,
    common: (await import('./Common_vX1rs6M9.mjs')).default,
    doc: (await import('./Doc_8A8AkYjO.mjs').then(n => n.b)).default,
    home: (await import('./Home_DN_-k5Pn.mjs').then(n => n.a)).default,
    download: (await import('./Download_Ck1ZgmMa.mjs').then(n => n.b)).default,
    account: (await import('./Account_D2JkIviN.mjs')).default,
    verify: (await import('./Verify_TPb8E8qQ.mjs').then(n => n.V)).default,
    header: (await import('./Home_CvAKDKAw.mjs').then(n => n.H)).default,
    footer: (await import('./Turbulence_Be3bv8bE.mjs').then(n => n.F)).default,
    meta: (await import('./Meta_hHADzK8O.mjs').then(n => n.a)).default
  })
...
function DropdownMenuItem({
  ...
  return /* @__PURE__ */ jsx(
    DropdownMenuPrimitive.Item,
    {
      ...
      className: cn(
        "data-[variant=destructive]:focus:bg-destructive/10 data-[variant=destructive]:*:[svg]:!text-destructive outline-hidden relative flex cursor-default select-none items-center gap-2 rounded-none px-2 py-1.5 text-sm focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[inset]:pl-8 data-[variant=destructive]:text-destructive data-[disabled]:opacity-50 data-[variant=destructive]:focus:text-destructive [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      ),
      ...props
    }
...
const LocaleSwitcher = () => {
  ...
  return /* @__PURE__ */ jsxs(DropdownMenu, { modal: false, children: [
    /* @__PURE__ */ jsxs(
      DropdownMenuTrigger,
      {
        className: "flex h-9 items-center gap-1.5 rounded-md border border-[var(--Border)] bg-white px-3 text-sm font-medium text-[var(--Foreground)] outline-none ring-offset-white hover:bg-[var(--Mute)] focus-visible:ring-2 focus-visible:ring-[var(--Ring)] focus-visible:ring-offset-2 data-[state=open]:bg-[var(--Mute)]",
...
const Header = ({ Content, AuthSlot }) => {
  ...
  const RenderActionIcon = (IconName, Label) => {
...
export { Button as B, DropdownMenu as D, Header as H, DropdownMenuTrigger as a, DropdownMenuContent as b, DropdownMenuItem as c, DropdownMenuSeparator as d };
