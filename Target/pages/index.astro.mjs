import { c as createComponent, s as spreadAttributes, d as renderSlotToString, e as renderAllHeadContent, u as unescapeHTML, f as createAstro, r as renderTemplate, g as addAttribute, b as renderScript, h as renderComponent, m as maybeRenderHead, i as renderSlot } from '../chunks/astro/server__zXXJFoi.mjs';
import 'kleur/colors';
/* empty css                                 */
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "D:/Developer/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "D:/Developer/node_modules/astro/components/ClientRouter.astro", void 0);

const $$Astro = createAstro("HTTPS://Editor.Land");
const $$Base = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Base;
  const { Title = "Land", Description = "Code Editor" } = Astro2.props;
  return renderTemplate`<html lang="en" class="no-js" dir="ltr"> ${renderComponent($$result, "Head", Head, {}, { "default": ($$result2) => renderTemplate`${renderScript($$result2, "D:/Developer/Application/CodeEditorLand/WebSite/Source/Layout/Base.astro?astro&type=script&index=0&lang.ts")}<title>${Title}</title><meta charset="utf-8"><meta name="description"${addAttribute(Description, "content")}><meta name="viewport" content="width=device-width,initial-scale=1.0"><meta name="theme-color" content="#ffffff"><meta name="format-detection" content="telephone=no"><meta name="twitter:dnt" content="on"><link rel="preconnect" href="https://fonts.googleapis.com" crossorigin><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link rel="manifest" href="/site.webmanifest" crossorigin="use-credentials">${renderSlot($$result2, $$slots["Head"])}${renderComponent($$result2, "ClientRouter", $$ClientRouter, {})}` })}${maybeRenderHead()}<body> <div class="grow"> ${renderSlot($$result, $$slots["default"])} </div> ${renderScript($$result, "D:/Developer/Application/CodeEditorLand/WebSite/Source/Layout/Base.astro?astro&type=script&index=1&lang.ts")} </body> </html>`;
}, "D:/Developer/Application/CodeEditorLand/WebSite/Source/Layout/Base.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Base", $$Base, {})}`;
}, "D:/Developer/Application/CodeEditorLand/WebSite/Source/pages/index.astro", void 0);

const $$file = "D:/Developer/Application/CodeEditorLand/WebSite/Source/pages/index.astro";
const $$url = "";
