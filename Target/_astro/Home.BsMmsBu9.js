const e={badge:"Features",item:{designTokens:{description:`Hören Sie auf, VS Code ein Gigabyte RAM zu übergeben, nur um eine Datei zu öffnen.
...
Land ist die Zukunft der Desktop-Editoren.`},subtitle:"Community-Stimmen zur Zukunft der Code-Bearbeitung.",title:"Was Entwickler sagen",badge:"Erfahrungsberichte",attribution:"Community-Feedback",attributionNote:"Repräsentatives Community-Mitglied"},s={title:"Roadmap und was Sie erwarten können",subtitle:`Finanziert durch den NLnet NGI0 Commons Fund.
...
Plant und verteilt Aufgaben auf Kerne für maximalen Durchsatz.`,subtitle:"Jedes CPU-Kern wird genutzt"},heading:"Wie die Architektur funktioniert",intro:"Land ersetzt Electrons VS Code-Stack Element für Element."},a={features:e,hero:n,nav:t,pricing:i,testimonials:r,roadmap:s,architecture:o};export{o as architecture,a as default,e as features,n as hero,t as nav,i as pricing,s as roadmap,r as testimonials};
