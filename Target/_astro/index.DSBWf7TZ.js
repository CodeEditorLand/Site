		...
		(function () {
			for (const e of ["touchstart", "mousedown"])
				document.body.addEventListener(
					...
					(e) => {
						i(e.target, "tap") &&
							c(e.target.href, { ignoreSlowConnection: !0 });
					},
					{ passive: !0 },
				);
		})(),
...
function c(t, n) {
	if (
		(function (t, n) {
			...
			return !1;
		})((t = t.replace(/#.*/, "")), n?.ignoreSlowConnection ?? !1)
	)
		if ((e.add(t), HTMLScriptElement.supports?.("speculationrules")))
			!(function (e, t) {
				const n = document.createElement("script");
				(n.type = "speculationrules"),
					(n.textContent = JSON.stringify({
						prerender: [
							{ source: "list", urls: [e], eagerness: t },
						],
						prefetch: [{ source: "list", urls: [e], eagerness: t }],
					})),
					document.head.append(n);
			})(t, n?.eagerness ?? "immediate");
		else if (
