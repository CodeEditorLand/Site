const e={badge:"Características",item:{designTokens:{description:`Deje de darle a VS Code un gigabyte de RAM solo para abrir un archivo.
...
Herramientas conocidas, sin compromisos.`,title:"Cadena de herramientas de primer nivel"}},subtitle:"Seis razones por las que Land es más rápido, más seguro y más abierto que cualquier editor basado en Electron.",title:"Diferente por diseño. Mejor de forma medible."},a={badge:"Velocidad nativa Sin Electron CC0",subtitle:`Deje de darle a VS Code un gigabyte de RAM.
...
Planifica y distribuye tareas entre núcleos para máximo rendimiento.`,subtitle:"Usa todos los núcleos de CPU"},heading:"Cómo funciona la arquitectura",intro:"Land reemplaza el stack Electron de VS Code elemento por elemento."},s={features:e,hero:a,nav:i,pricing:o,testimonials:n,roadmap:t,architecture:r};export{r as architecture,s as default,e as features,a as hero,i as nav,o as pricing,t as roadmap,n as testimonials};
