...
Built in public, free forever, no roadmap surprises.`,tiers:{current:{name:"Active Now",description:"All fifteen elements are in active development. Each is a standalone repository you can inspect and contribute to today.",features:{air:"Air 🪁 Background Daemon Silent Auto-Update Crypto-Signed",cocoon:"Cocoon 🦋 Extension Host Full VS Code API Effect-TS Shim",common:"Common 👨🏻‍🏭 Abstract Rust Foundation Typed Effect Zero Concrete Implementation",echo:"Echo 📣 Lock-Free Work-Stealing Scheduler Every CPU Core",grove:"Grove 🌳 WASMtime Sandbox Capability-Based Isolation",maintain:"Maintain 💪🏻 Build Orchestrator Rhai Scripting TOML/JSON5 Config",mist:"Mist 🌫️ DNS Sandbox Local *.editor.land Resolution",mountain:"Mountain ⛰️ Native Rust/Tauri Backend Replaces Electron Main Process",output:"Output ⚫ Compilation Pipeline Deterministic Bundle Checksum",rest:"Rest ⛱️ TypeScript Compiler Rust + OXC 2-3x Faster",sidecar:"SideCar ⚙️ Binary Distributor Node.js Runtime Per Platform",sky:"Sky 🌌 Astro UI Layer Instant Hot-Reload",vine:"Vine 🌿 gRPC Backbone Contract-First .proto Definition",wind:"Wind 🍃 VS Code Workbench Reimplemented TypeScript + Effect-TS",worker:"Worker 🍩 Service Worker Offline Support AES-GCM Auth"},button:"View on GitHub"},next:{name:"Coming Next",description:"Extension ecosystem polish and first stable release across all three platforms.",features:{1:"High-fidelity VS Code extension compatibility pass",2:"Cross-platform installer with silent auto-update",3:"gRPC IPC protocol finalized and documented",4:"Settings sync with cloud-optional portal"},button:"Track Progress"},future:{name:"Long-Term Vision",description:"A full-featured, Electron-free editor that handles every workflow a modern developer needs.",features:{1:"Native mobile editing: iOS and Android",2:"Collaborative real-time editing built in",3:"AI-assisted development, privacy-first",4:"Open plugin marketplace and extension ecosystem"},button:"Learn More"}}},a={title:"Under the Hood",subtitle:`Land replaces VS Code's Electron stack element by element.
...
Same commit, same output. Every bundle is deterministic and checksum-verified.`},rest:{subtitle:"TypeScript Compiler Rust + OXC 2-3x Faster",description:`A drop-in replacement for VS Code TypeScript build step. Powered by OXC, the same parser VS Code uses internally, for 100% compatible output at 2-3x the speed of esbuild.
