	...
	r = {
		...
		encodeByteArray(e, t) {
			...
			for (let a = 0; a < e.length; a += 3) {
				...
				let d = ((15 & s) << 2) | (c >> 6),
					u = 63 & c;
				o || ((u = 64), i || (d = 64)), n.push(r[h], r[l], r[d], r[u]);
			}
			return n.join("");
		},
		encodeString(e, r) {
		...
		decodeStringToByteArray(e, t) {
			...
			for (let i = 0; i < e.length; ) {
				const t = r[e.charAt(i++)],
					s = i < e.length ? r[e.charAt(i)] : 0;
				++i;
				const o = i < e.length ? r[e.charAt(i)] : 64;
				++i;
				const c = i < e.length ? r[e.charAt(i)] : 64;
				if ((++i, null == t || null == s || null == o || null == c))
					throw new n();
				const h = (t << 2) | (s >> 4);
				if ((a.push(h), 64 !== o)) {
					const e = ((s << 4) & 240) | (o >> 2);
		...
		try {
			return (
				...
				(() => {
					...
					const t = e.__FIREBASE_DEFAULTS__;
...
function u(e, t) {
	...
	for (const a of n) if (!r.includes(a)) return !1;
	return !0;
}
function f(e) {
 ...
 */ class b {
	...
	initialize(e = {}) {
		...
		for (const [a, i] of this.instancesDeferred.entries()) {
			r === this.normalizeInstanceIdentifier(a) && i.resolve(n);
		}
		return n;
	}
	onInit(e, t) {
	...
	getOrInitializeService({ instanceIdentifier: e, options: t = {} }) {
		...
		if (
			...
			((r = this.component.instanceFactory(this.container, {
				instanceIdentifier: ((n = e), n === g ? void 0 : n),
				options: t,
			})),
...
function N(e) {
	return e !== IDBDatabase.prototype.transaction ||
		...
		? (
			...
			? function (...t) {
					return e.apply(R(this), t), M(D.get(this));
				}
			: function (...t) {
					return M(e.apply(R(this), t));
				}
		: function (t, ...r) {
				const n = e.call(R(this), t, ...r);
				return A.set(n, t.sort ? t.sort() : [t]), M(n);
			};
}
function T(e) {
...
function M(e) {
	...
	const t = T(e);
	return t !== e && (B.set(e, t), O.set(t, e)), t;
}
const R = (e) => O.get(e);
...
L = ((e) => ({
	...e,
	get: (t, r, n) => P(t, r) || e.get(t, r, n),
	has: (t, r) => !!P(t, r) || e.has(t, r),
}))(L);
/**
 * @license
 * Copyright 2019 Google LLC
...
const j = "@firebase/app",
	...
	z = "@firebase/app-compat",
	U = "@firebase/analytics-compat",
	W = "@firebase/analytics",
	G = "@firebase/app-check-compat",
	J = "@firebase/app-check",
	K = "@firebase/auth",
	Y = "@firebase/auth-compat",
	q = "@firebase/database",
	X = "@firebase/data-connect",
	Z = "@firebase/database-compat",
	Q = "@firebase/functions",
	ee = "@firebase/functions-compat",
	te = "@firebase/installations",
	re = "@firebase/installations-compat",
	ne = "@firebase/messaging",
	ae = "@firebase/messaging-compat",
	ie = "@firebase/performance",
	se = "@firebase/performance-compat",
	oe = "@firebase/remote-config",
	ce = "@firebase/remote-config-compat",
	he = "@firebase/storage",
	le = "@firebase/storage-compat",
	de = "@firebase/firestore",
	ue = "@firebase/ai",
	fe = "@firebase/firestore-compat",
	pe = "firebase",
	ge = "[DEFAULT]",
	be = {
		[j]: "fire-core",
		[z]: "fire-core-compat",
		[W]: "fire-analytics",
		[U]: "fire-analytics-compat",
		[J]: "fire-app-check",
		[G]: "fire-app-check-compat",
		[K]: "fire-auth",
		[Y]: "fire-auth-compat",
		[q]: "fire-rtdb",
		[X]: "fire-data-connect",
...
function ye(e) {
	...
	if (_e.has(t))
		return (
			x.debug(`There were multiple attempts to register component ${t}.`),
			!1
		);
	_e.set(t, e);
	for (const r of me.values()) Ee(r, e);
	for (const r of ve.values()) Ee(r, e);
	return !0;
}
/**
 * @license
...
function Se(e, t = {}) {
	...
	const n = Object.assign(
			{ name: ge, automaticDataCollectionEnabled: !0 },
			t,
		),
		a = n.name;
	if ("string" != typeof a || !a)
		throw we.create("bad-app-name", { appName: String(a) });
	var i;
	if ((r || (r = null === (i = o()) || void 0 === i ? void 0 : i.config), !r))
		throw we.create("no-options");
	const s = me.get(a);
	if (s) {
		if (u(r, s.options) && u(n, s.config)) return s;
		throw we.create("duplicate-app", { appName: a });
	}
	const c = new m(a);
	for (const o of _e.values()) c.addComponent(o);
	const h = new Ie(r, n, c);
	return me.set(a, h), h;
}
function De(e, t, r) {
	var n;
	let a = null !== (n = be[e]) && void 0 !== n ? n : e;
	r && (a += `-${r}`);
	const i = a.match(/\s|\//),
		s = t.match(/\s|\//);
	if (i || s) {
	...
	ye(new p(`${a}-version`, () => ({ library: a, version: t }), "VERSION"));
}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const Ce = "firebase-heartbeat-store";
let Ae = null;
function Be() {
	return (
		Ae ||
...
async function Oe(e, t) {
	try {
		const r = (await Be()).transaction(Ce, "readwrite"),
			n = r.objectStore(Ce);
		await n.put(t, Le(e)), await r.done;
	} catch (r) {
		if (r instanceof h) x.warn(r.message);
		else {
			const e = we.create("idb-set", {
				originalErrorMessage: null == r ? void 0 : r.message,
			});
			x.warn(e.message);
		}
	}
			...
			const t = Te(),
				{ heartbeatsToSend: r, unsentEntries: n } = (function (
					...
					for (const a of e) {
						...
						if (e) {
							if ((e.dates.push(a.date), Re(r) > t)) {
								e.dates.pop();
								break;
							}
						} else if (
							(r.push({ agent: a.agent, dates: [a.date] }),
							Re(r) > t)
						) {
							r.pop();
							break;
	...
	async read() {
		if (await this._canUseIndexedDBPromise) {
			const e = await (async function (e) {
				try {
					const t = (await Be()).transaction(Ce),
						r = await t.objectStore(Ce).get(Le(e));
					return await t.done, r;
				} catch (t) {
					if (t instanceof h) x.warn(t.message);
					else {
						const e = we.create("idb-get", {
...
var $e;
($e = ""),
	ye(new p("platform-logger", (e) => new F(e), "PRIVATE")),
	ye(new p("heartbeat", (e) => new Ne(e), "PRIVATE")),
	De(j, V, $e),
	De(j, V, "esm2017"),
	De("fire-js", "");
/**
 ...
 * limitations under the License.
 */
De("firebase", "11.9.0", "app");
export {
	h as FirebaseError,
	ge as _DEFAULT_ENTRY_NAME,
	Ee as _addComponent,
	me as _apps,
	_e as _components,
	ye as _registerComponent,
	ve as _serverApps,
	Se as initializeApp,
	De as registerVersion,
};
