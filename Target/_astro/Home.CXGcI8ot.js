...
Land est l'avenir des éditeurs de bureau.`},subtitle:"Les voix de la communauté sur l'avenir de l'édition de code.",title:"Ce que disent les développeurs",badge:"Témoignages",attribution:"Retour de la communauté",attributionNote:"Membre représentatif de la communauté"},o={title:"Feuille de route & Prévisions",subtitle:`Financé par le fonds NGI0 Commons.
...
Planifie et distribue les tâches sur les cœurs pour un débit maximum.`,subtitle:"Planificateur de tâches Rust"}},a={features:e,hero:t,nav:n,pricing:i,testimonials:s,roadmap:o,architecture:r};export{r as architecture,a as default,e as features,t as hero,n as nav,i as pricing,o as roadmap,s as testimonials};
