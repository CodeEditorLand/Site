...
Тежкото индексиране и анализите се случват на заден план. Редакторът остава отзивчив.`,subtitle:"Използва всяко CPU ядро, което имате"}},c={features:t,hero:n,nav:e,pricing:o,testimonials:i,roadmap:r,architecture:s};export{s as architecture,c as default,t as features,n as hero,e as nav,o as pricing,r as roadmap,i as testimonials};
