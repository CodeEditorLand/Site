	...
	return (
		<SwitchPrimitive.Root
			...
			<SwitchPrimitive.Thumb
				...
				className={cn(
					"pointer-events-none block size-4 rounded-none bg-card ring-0 transition-transform data-[state=checked]:translate-x-[calc(100%-3px)] data-[state=unchecked]:translate-x-0",
				)}
			/>
		</SwitchPrimitive.Root>
	);
