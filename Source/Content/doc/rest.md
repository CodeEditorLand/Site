...
Rest is WIP build-tooling work. It should be labeled `WIP` anywhere the website
talks about replacing or outperforming other compilers. Output compatibility,
source maps, and measured pipeline speed need published validation before they
