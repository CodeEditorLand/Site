...
Using the system WebView means Land depends on the OS vendor's rendering engine.
Rendering behavior can differ slightly between macOS, Windows, and Linux. Land
mitigates this by targeting a well-defined subset of web platform features and
testing across all three platforms in CI. The trade-off is worth it: users get a
lighter, faster application, and Land avoids the maintenance burden of bundling
and patching a private browser.
