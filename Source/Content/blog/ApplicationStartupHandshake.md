---
title: "Application Startup Handshake: How Mountain, Cocoon, Sky, and Wind Bootstrap"
summary: "The complete end-to-end process from launching the native binary to a fully initialized editor with running extensions."
...
3. **`AppRuntime`** wraps the environment. This is the engine that executes `ActionEffect`s: declarative descriptions of work with typed error channels and deterministic resource cleanup.
